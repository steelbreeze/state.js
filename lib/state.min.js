...
void 0===i&&(i=t.TransitionKind.External),this.source=n,this.target=e,this.transitionBehavior=[],this.onTraverse=[],this.guard=n instanceof t.PseudoState?function(){return!0}:function(t){return t===o.source},this.kind=e?i:t.TransitionKind.Internal,this.source.outgoing.push(this),this.source.getRoot().clean=!1}return n.prototype["else"]=function(){return this.guard=n.isElse,this},n.prototype.when=function(t){return this.guard=t,this},n.prototype.effect=function(t){return this.transitionBehavior.push(t),this.source.getRoot().clean=!1,this},n.prototype.accept=function(t,n,e,i){return t.visitTransition(this,n,e,i)},n.prototype.toString=function(){return"["+(this.target?this.source+" -> "+this.target:this.source)+"]"},n.isElse=function(){return!1},n}()
t.Transition=n}(e||(e={}))
var e
...
var e
!function(t){function n(t){t.accept(new p)}function e(t,n,i){void 0===i&&(i=!0),n?(i&&t.clean===!1&&e(t),t.logTo.log("initialise "+n),t.onInitialise.forEach(function(t){return t(void 0,n)})):(t.logTo.log("initialise "+t.name),t.accept(new f,!1),t.clean=!0)}function o(t,n,i,o){return void 0===o&&(o=!0),t.logTo.log(n+" evaluate "+i),o&&t.clean===!1&&e(t),n.isTerminated?!1:r(t,n,i)}function r(n,e,i){var o=!1
if(n.regions.every(function(a){return r(e.getCurrent(a),e,i)&&(o=!0,!t.isActive(n,e))?!1:!0}),o)i!==n&&t.isComplete(n,e)&&r(n,e,n)
else{var s
n.outgoing.forEach(function(t){t.guard(i,e)&&(s&&n.getRoot().errorTo.error("Multiple outbound transitions evaluated true"),s=t)}),s&&(o=a(s,e,i))}return o}function a(n,e,i){for(var o=n.onTraverse,u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)n=s(u,e,i),u=n.target,Array.prototype.push.apply(o,n.onTraverse)
...
return n.outgoing.forEach(function(s){s.guard===t.Transition.isElse?(o&&n.getRoot().errorTo.error("Multiple outbound else transitions found at "+r+" for "+i),o=s):s.guard(i,e)&&a.push(s)}),n.kind===t.PseudoStateKind.Choice?0!==a.length?a[t.getRandom()(a.length)]:o:n.kind===t.PseudoStateKind.Junction?(a.length>1&&n.getRoot().errorTo.error("Multiple outbound transition guards returned true at "+this+" for "+i),a[0]||o):void 0}function u(t){return(t.region?u(t.region.state).concat(t.region):[]).concat(t)}t.validate=n,t.initialise=e,t.evaluate=o
var c=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[]}return t}(),h=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitTransition=function(n,e){switch(n.kind){case t.TransitionKind.Internal:n.onTraverse=n.transitionBehavior
break
...
for(e[r.getCurrent(a[s].region).qualifiedName].leave.forEach(function(t){return t(o,r)}),n.transitionBehavior.forEach(function(t){return t(o,r)});s<a.length;)i.cascadeElementEntry(n,e,a[s++],s<a.length?a[s]:void 0,function(t){t.forEach(function(t){return t(o,r)})})
e[n.target.qualifiedName].endEnter.forEach(function(t){return t(o,r)})})},e.prototype.visitExternalTransition=function(t,n){for(var e=u(t.source),i=u(t.target),o=Math.min(e.length,i.length)-1;e[o-1]!==i[o-1];)o--
for(Array.prototype.push.apply(t.onTraverse,n[e[o].qualifiedName].leave),Array.prototype.push.apply(t.onTraverse,t.transitionBehavior);o<i.length;)this.cascadeElementEntry(t,n,i[o++],i[o],function(n){Array.prototype.push.apply(t.onTraverse,n)})
Array.prototype.push.apply(t.onTraverse,n[t.target.qualifiedName].endEnter)},e.prototype.cascadeElementEntry=function(n,e,i,o,r){r(e[i.qualifiedName].beginEnter),o&&i instanceof t.State&&i.isOrthogonal()&&i.regions.forEach(function(t){t!==o&&r(e[t.qualifiedName].enter)})},e}(t.Visitor),f=function(n){function e(){n.apply(this,arguments),this.behaviours={}}return i(e,n),e.prototype.behaviour=function(t){return this.behaviours[t.qualifiedName]||(this.behaviours[t.qualifiedName]=new c)},e.prototype.visitRegion=function(n,e){var i=this,o=this.behaviour(n),r=n.getInitial()
...
this.visitVertex(n,e),n.isInitial()?this.behaviour(n).endEnter.push(function(t,e){return a(n.outgoing[0],e)}):n.kind===t.PseudoStateKind.Terminate&&i.beginEnter.push(function(t,n){return n.isTerminated=!0}),i.enter=i.beginEnter.concat(i.endEnter)},e.prototype.visitState=function(t,n){var e=this,i=this.behaviour(t)
t.regions.forEach(function(t){var o=e.behaviour(t)
t.accept(e,n),Array.prototype.push.apply(i.leave,o.leave),Array.prototype.push.apply(i.endEnter,o.enter)}),this.visitVertex(t,n),Array.prototype.push.apply(i.leave,t.exitBehavior),Array.prototype.push.apply(i.beginEnter,t.entryBehavior),i.beginEnter.push(function(n,e){t.region&&e.setCurrent(t.region,t)}),i.enter=i.beginEnter.concat(i.endEnter)},e.prototype.visitStateMachine=function(t,n){this.visitState(t,n),t.accept(new h,this.behaviours),t.onInitialise=this.behaviour(t).enter},e}(t.Visitor),p=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitRegion=function(e){n.prototype.visitRegion.call(this,e)
var i
