...
if(void 0===i&&(i=t.TransitionKind.External),this.source=n,this.target=e,this.transitionBehavior=[],this.onTraverse=[],this.guard=n instanceof t.PseudoState?function(){return!0}:function(t){return t===o.source},this.kind=e?i:t.TransitionKind.Internal,this.kind===t.TransitionKind.Local){var r=e
do if(r===n)return
...
var u=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[]}return t}(),c=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitTransition=function(n,e){switch(n.kind){case t.TransitionKind.Internal:n.onTraverse=n.transitionBehavior
break
...
n.onTraverse.push(function(o,r){for(var a=s(n.target),u=0;t.isActive(a[u],r);)u++
