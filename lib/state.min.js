...
var e
!function(t){function n(t,n,e,i){void 0===i&&(i=!1),t.forEach(function(t){return t(n,e,i)})}function e(i,o,r){void 0===r&&(r=!0),o?(r&&i.clean===!1&&e(i),t.logger.log("initialise "+o),n(i.onInitialise,void 0,o)):(t.logger.log("initialise "+i.name),i.accept(new l,!1),i.clean=!0)}function o(n,i,o,a){return void 0===a&&(a=!0),t.logger.log(i+" evaluate "+o),a&&n.clean===!1&&e(n),i.isTerminated?!1:r(n,i,o)}function r(n,e,i){var o=!1
...
1===s.length?o=a(s[0],e,i):s.length>1&&t.logger.error(n+": multiple outbound transitions evaluated true for message "+i)}return o}function a(e,i,o){for(var u=e.onTraverse,c=e.target;c&&c instanceof t.PseudoState&&c.kind===t.PseudoStateKind.Junction;)c=(e=s(c,i,o)).target,Array.prototype.push.apply(u,e.onTraverse)
...
e.prototype.visitRegion.call(this,i,o||a&&a.kind===t.PseudoStateKind.DeepHistory),this.behaviour(i).leave.push(function(t,e){return n(r.behaviour(e.getCurrent(i)).leave,t,e)}),o||!a||a.isHistory()?this.behaviour(i).endEnter.push(function(e,o,s){n(r.behaviour(s||a.isHistory()?o.getCurrent(i)||a:a).enter(),e,o,s||a.kind===t.PseudoStateKind.DeepHistory)}):Array.prototype.push.apply(this.behaviour(i).endEnter,this.behaviour(a).enter()),this.addLogging(i,t.logger)},o.prototype.visitVertex=function(n){this.addLogging(n,t.logger)},o.prototype.visitPseudoState=function(n,i){e.prototype.visitPseudoState.call(this,n,i),n.isInitial()?this.behaviour(n).endEnter.push(function(t,e){return a(n.outgoing[0],e)}):n.kind===t.PseudoStateKind.Terminate&&this.behaviour(n).beginEnter.push(function(t,n){return n.isTerminated=!0})},o.prototype.visitState=function(t,n){var e=this
...
e.prototype.visitStateMachine.call(this,t,n),t.accept(new p,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter()},o}(t.Visitor),f={log:function(){},warn:function(){},error:function(t){throw t}}
t.logger=f}(e||(e={}))
var e
