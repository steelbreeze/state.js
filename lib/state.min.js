...
return n.kind===t.PseudoStateKind.Choice?0!==o.length?o[t.getRandom()(o.length)]:s(n):o.length>1?void t.console.error("Multiple outbound transition guards returned true at "+this+" for "+e):o[0]||s(n)}function s(n){return n.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard})[0]}function u(n){return new t.Behavior(n[f]).push(n[l])}function c(t){return(t.region?c(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=i
var h=0,f=1,l=2,p=function(n){function i(){n.apply(this,arguments)}return e(i,n),i.prototype.visitTransition=function(n,i){n.kind===t.TransitionKind.Internal?n.onTraverse.push(n.transitionBehavior):n.kind===t.TransitionKind.Local?this.visitLocalTransition(n,i):this.visitExternalTransition(n,i)},i.prototype.visitLocalTransition=function(n,i){var e=this
n.onTraverse.push(function(o,r){for(var a=c(n.target),s=0;t.isActive(a[s],r);)++s
for(i(r.getCurrent(a[s].region))[h].invoke(o,r),n.transitionBehavior.invoke(o,r);s<a.length;)e.cascadeElementEntry(n,i,a[s++],a[s],function(t){t.invoke(o,r)})
i(n.target)[l].invoke(o,r)})},i.prototype.visitExternalTransition=function(t,n){for(var i=c(t.source),e=c(t.target),o=Math.min(i.length,e.length)-1;i[o-1]!==e[o-1];)--o
for(t.onTraverse.push(n(i[o])[h]),t.onTraverse.push(t.transitionBehavior);o<e.length;)this.cascadeElementEntry(t,n,e[o++],e[o],function(n){return t.onTraverse.push(n)})
t.onTraverse.push(n(t.target)[l])},i.prototype.cascadeElementEntry=function(n,i,e,o,r){r(i(e)[f]),o&&e instanceof t.State&&e.regions.forEach(function(t){r(i(t)[f]),t!==o.region&&r(i(t)[l])})},i}(t.Visitor),v=function(n){function i(){n.apply(this,arguments),this.behaviours=[]}return e(i,n),i.prototype.behaviour=function(n){return this.behaviours[n.qualifiedName]||(this.behaviours[n.qualifiedName]=[new t.Behavior,new t.Behavior,new t.Behavior])},i.prototype.visitElement=function(n){t.console!==g&&(this.behaviour(n)[h].push(function(i,e){return t.console.log(e+" leave "+n)}),this.behaviour(n)[f].push(function(i,e){return t.console.log(e+" enter "+n)}))},i.prototype.visitRegion=function(n,i){var e=this,o=n.vertices.reduce(function(n,i){return i instanceof t.PseudoState&&i.isInitial()?i:n},void 0)
n.vertices.forEach(function(n){n.accept(e,i||o&&o.kind===t.PseudoStateKind.DeepHistory)}),this.behaviour(n)[h].push(function(t,i){return e.behaviour(i.getCurrent(n))[h].invoke(t,i)}),this.behaviour(n)[l].push(i||!o||o.isHistory()?function(i,r,a){u(e.behaviour(a||o.isHistory()?r.getCurrent(n)||o:o)).invoke(i,r,a||o.kind===t.PseudoStateKind.DeepHistory)}:u(this.behaviour(o))),this.visitElement(n,i)},i.prototype.visitPseudoState=function(i,e){n.prototype.visitPseudoState.call(this,i,e),i.isInitial()?this.behaviour(i)[l].push(function(t,n){return r(i.outgoing[0],n)}):i.kind===t.PseudoStateKind.Terminate&&this.behaviour(i)[f].push(function(t,n){return n.isTerminated=!0})},i.prototype.visitState=function(t,n){var i=this
t.regions.forEach(function(e){e.accept(i,n),i.behaviour(t)[h].push(i.behaviour(e)[h]),i.behaviour(t)[l].push(u(i.behaviour(e)))}),this.visitVertex(t,n),this.behaviour(t)[h].push(t.exitBehavior),this.behaviour(t)[f].push(t.entryBehavior),this.behaviour(t)[f].push(function(n,i){t.region&&i.setCurrent(t.region,t)})},i.prototype.visitStateMachine=function(t,i){var e=this
n.prototype.visitStateMachine.call(this,t,i),t.accept(new p,function(t){return e.behaviour(t)}),t.onInitialise=u(this.behaviour(t))},i}(t.Visitor),g={log:function(){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]},warn:function(){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]},error:function(t){for(var n=[],i=1;i<arguments.length;i++)n[i-1]=arguments[i]
throw t}}
t.console=g}(i||(i={}))
var i
