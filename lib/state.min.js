...
return o.forEach(function(t){return t(i,e)}),u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?a(s(u,e,i),e,i):u&&u instanceof t.State&&t.isComplete(u,e)&&r(u,e,u),!0}function s(n,e,i){var o,r=this,a=[]
return n.outgoing.forEach(function(s){s.guard===t.Transition.FalseGuard?(o&&n.getRoot().errorTo.error("Multiple outbound else transitions found at "+r+" for "+i),o=s):s.guard(i,e)&&a.push(s)}),n.kind===t.PseudoStateKind.Choice?0!==a.length?a[t.getRandom()(a.length)]:o:n.kind===t.PseudoStateKind.Junction?(a.length>1&&n.getRoot().errorTo.error("Multiple outbound transition guards returned true at "+this+" for "+i),a[0]||o):void 0}function u(t){return(t.region?u(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=e,t.validate=o
