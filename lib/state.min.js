...
1===a.length?s=r(a[0],n,i):a.length>1&&t.console.error(e+": multiple outbound transitions evaluated true for message "+i)}return s}function r(e,n,i){for(var a=e,u=a.target,c=new t.Behavior(a.onTraverse);u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)a=s(u,n,i),u=a.target,c.push(a.onTraverse)
return c.invoke(i,n),u&&(u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?r(s(u,n,i),n,i):u instanceof t.State&&t.isComplete(u,n)&&o(u,n,u)),!0}function s(e,n,i){var o=e.outgoing.filter(function(t){return t.guard(i,n)})
...
var u=function(){function e(){this.leave=new t.Behavior,this.beginEnter=new t.Behavior,this.endEnter=new t.Behavior}return e.prototype.enter=function(){return new t.Behavior(this.beginEnter).push(this.endEnter)},e}(),c=function(e){function n(){e.apply(this,arguments)}return i(n,e),n.prototype.visitTransition=function(e,n){switch(e.onTraverse=new t.Behavior,e.kind){case t.TransitionKind.Internal:this.visitInternalTransition(e,n)
break
case t.TransitionKind.Local:this.visitLocalTransition(e,n)
break
case t.TransitionKind.External:this.visitExternalTransition(e,n)}},n.prototype.visitInternalTransition=function(e){e.onTraverse.push(e.transitionBehavior),t.internalTransitionsTriggerCompletion&&e.onTraverse.push(function(n,i){var r=e.source
t.isComplete(r,i)&&o(r,i,r)})},n.prototype.visitLocalTransition=function(e,n){var i=this
...
t.onTraverse.push(e(t.target).endEnter)},n.prototype.cascadeElementEntry=function(e,n,i,o,r){r(n(i).beginEnter),o&&i instanceof t.State&&i.regions.forEach(function(t){r(n(t).beginEnter),t!==o.region&&r(n(t).endEnter)})},n}(t.Visitor),h=function(e){function n(){e.apply(this,arguments),this.behaviors={}}return i(n,e),n.prototype.behavior=function(t){return this.behaviors[t.qualifiedName]||(this.behaviors[t.qualifiedName]=new u)},n.prototype.visitElement=function(e){t.console!==l&&(this.behavior(e).leave.push(function(n,i){return t.console.log(i+" leave "+e)}),this.behavior(e).beginEnter.push(function(n,i){return t.console.log(i+" enter "+e)}))},n.prototype.visitRegion=function(e,n){var i=this,o=e.vertices.reduce(function(e,n){return n instanceof t.PseudoState&&n.isInitial()?n:e},void 0)
e.vertices.forEach(function(e){return e.accept(i,n||o&&o.kind===t.PseudoStateKind.DeepHistory)}),this.behavior(e).leave.push(function(t,n){return i.behavior(n.getCurrent(e)).leave.invoke(t,n)}),this.behavior(e).endEnter.push(n||!o||o.isHistory()?function(n,r,s){return i.behavior(s||o.isHistory()?r.getCurrent(e)||o:o).enter().invoke(n,r,s||o.kind===t.PseudoStateKind.DeepHistory)}:this.behavior(o).enter()),this.visitElement(e,n)},n.prototype.visitPseudoState=function(n,i){var o=this
e.prototype.visitPseudoState.call(this,n,i),n.isInitial()?this.behavior(n).endEnter.push(function(e,i,s){i.getCurrent(n.region)?(o.behavior(n).leave.invoke(e,i),o.behavior(i.getCurrent(n.region)).enter().invoke(e,i,s||n.kind===t.PseudoStateKind.DeepHistory)):r(n.outgoing[0],i)}):n.kind===t.PseudoStateKind.Terminate&&this.behavior(n).beginEnter.push(function(t,e){return e.isTerminated=!0})},n.prototype.visitState=function(t,e){var n=this
