...
var e
!function(t){function n(e,i,o){void 0===o&&(o=!0),i?(o&&e.clean===!1&&n(e),t.logger.log("initialise "+i),e.onInitialise.forEach(function(t){return t(void 0,i)})):(t.logger.log("initialise "+e.name),e.accept(new p,!1),e.clean=!0)}function e(e,i,r,a){return void 0===a&&(a=!0),t.logger.log(i+" evaluate "+r),a&&e.clean===!1&&n(e),i.isTerminated?!1:o(e,i,r)}function o(n,e,i){var a=!1
...
1===s.length?a=r(s[0],e,i):s.length>1&&t.logger.error(n+": multiple outbound transitions evaluated true for message "+i)}return a}function r(n,e,i){for(var s=n.onTraverse,u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)u=(n=a(u,e,i)).target,Array.prototype.push.apply(s,n.onTraverse)
...
Array.prototype.push.apply(t.onTraverse,n(t.target).endEnter)},e.prototype.cascadeElementEntry=function(n,e,i,o,r){r(e(i).beginEnter),o&&i instanceof t.State&&i.regions.forEach(function(t){r(e(t).beginEnter),t!==o.region&&r(e(t).endEnter)})},e}(t.Visitor),p=function(n){function e(){n.apply(this,arguments),this.behaviours={}}return i(e,n),e.prototype.behaviour=function(t){return this.behaviours[t.qualifiedName]||(this.behaviours[t.qualifiedName]=new c)},e.prototype.addLogging=function(t,n){n!==f&&(this.behaviour(t).leave.push(function(e,i){return n.log(i+" leave "+t)}),this.behaviour(t).beginEnter.push(function(e,i){return n.log(i+" enter "+t)}))},e.prototype.visitRegion=function(e,i){var o=this,r=e.vertices.reduce(function(n,e){return e instanceof t.PseudoState&&e.isInitial()?e:n},void 0)
n.prototype.visitRegion.call(this,e,i||r&&r.kind===t.PseudoStateKind.DeepHistory),this.behaviour(e).leave.push(function(t,n){return o.behaviour(n.getCurrent(e)).leave.forEach(function(e){return e(t,n)})}),i||!r||r.isHistory()?this.behaviour(e).endEnter.push(function(n,i,a){o.behaviour(a||r.isHistory()?i.getCurrent(e)||r:r).enter().forEach(function(e){return e(n,i,a||r.kind===t.PseudoStateKind.DeepHistory)})}):Array.prototype.push.apply(this.behaviour(e).endEnter,this.behaviour(r).enter()),this.addLogging(e,t.logger)},e.prototype.visitVertex=function(n){this.addLogging(n,t.logger)},e.prototype.visitPseudoState=function(e,i){n.prototype.visitPseudoState.call(this,e,i),e.isInitial()?this.behaviour(e).endEnter.push(function(t,n){return r(e.outgoing[0],n)}):e.kind===t.PseudoStateKind.Terminate&&this.behaviour(e).beginEnter.push(function(t,n){return n.isTerminated=!0})},e.prototype.visitState=function(t,n){var e=this
t.regions.forEach(function(i){i.accept(e,n),Array.prototype.push.apply(e.behaviour(t).leave,e.behaviour(i).leave),Array.prototype.push.apply(e.behaviour(t).endEnter,e.behaviour(i).enter())}),this.visitVertex(t,n),Array.prototype.push.apply(this.behaviour(t).leave,t.exitBehavior),Array.prototype.push.apply(this.behaviour(t).beginEnter,t.entryBehavior),this.behaviour(t).beginEnter.push(function(n,e){t.region&&e.setCurrent(t.region,t)})},e.prototype.visitStateMachine=function(t,e){var i=this
n.prototype.visitStateMachine.call(this,t,e),t.accept(new h,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter()},e}(t.Visitor),f={log:function(){},warn:function(){},error:function(t){throw t}}
t.logger=f}(e||(e={}))
var e
!function(t){function n(t){t.accept(new o)}function e(t){return(t.region?e(t.region.state):[]).concat(t)}t.validate=n
var o=function(n){function o(){n.apply(this,arguments)}return i(o,n),o.prototype.visitPseudoState=function(e){n.prototype.visitPseudoState.call(this,e),e.kind===t.PseudoStateKind.Choice||e.kind===t.PseudoStateKind.Junction?(0===e.outgoing.length&&t.logger.error(e+": "+e.kind+" pseudo states must have at least one outgoing transition."),e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length>1&&t.logger.error(e+": "+e.kind+" pseudo states cannot have more than one Else transitions.")):(0!==e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length&&t.logger.error(e+": "+e.kind+" pseudo states cannot have Else transitions."),e.isInitial()&&(1!==e.outgoing.length?t.logger.error(e+": initial pseudo states must have one outgoing transition."):e.outgoing[0].guard!==t.Transition.TrueGuard&&t.logger.error(e+": initial pseudo states cannot have a guard condition.")))},o.prototype.visitRegion=function(e){n.prototype.visitRegion.call(this,e)
var i
e.vertices.forEach(function(n){n instanceof t.PseudoState&&n.isInitial()&&(i&&t.logger.error(e+": regions may have at most one initial pseudo state."),i=n)})},o.prototype.visitState=function(e){n.prototype.visitState.call(this,e),e.regions.filter(function(n){return n.name===t.Region.defaultName}).length>1&&t.logger.error(e+": a state cannot have more than one region named "+t.Region.defaultName)},o.prototype.visitFinalState=function(e){n.prototype.visitFinalState.call(this,e),0!==e.outgoing.length&&t.logger.error(e+": final states must not have outgoing transitions."),0!==e.regions.length&&t.logger.error(e+": final states must not have child regions."),0!==e.entryBehavior.length&&t.logger.warn(e+": final states may not have entry behavior."),0!==e.exitBehavior.length&&t.logger.warn(e+": final states may not have exit behavior.")},o.prototype.visitTransition=function(i){n.prototype.visitTransition.call(this,i),i.kind===t.TransitionKind.Local&&-1===e(i.target).indexOf(i.source)&&t.logger.error(i+": local transition target vertices must be a child of the source composite sate.")},o}(t.Visitor)}(e||(e={}))
var n=n
