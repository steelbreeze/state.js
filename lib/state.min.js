...
var e
!function(t){function n(e,i,o){void 0===o&&(o=!0),i?(o&&e.clean===!1&&n(e),t.logTo.log("initialise "+i),e.onInitialise.forEach(function(t){return t(void 0,i)})):(t.logTo.log("initialise "+e.name),e.accept(new p,!1),e.clean=!0)}function e(e,i,r,a){return void 0===a&&(a=!0),t.logTo.log(i+" evaluate "+r),a&&e.clean===!1&&n(e),i.isTerminated?!1:o(e,i,r)}function o(n,e,i){var a=!1
...
1===s.length?a=r(s[0],e,i):s.length>1&&t.errorTo.error(n+": multiple outbound transitions evaluated true for message "+i)}return a}function r(n,e,i){for(var s=n.onTraverse,u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)u=(n=a(u,e,i)).target,Array.prototype.push.apply(s,n.onTraverse)
...
t.logTo=f,t.warnTo=f,t.errorTo=f}(e||(e={}))
var e
!function(t){function n(t){t.accept(new o)}function e(t){return(t.region?e(t.region.state):[]).concat(t)}t.validate=n
var o=function(n){function o(){n.apply(this,arguments)}return i(o,n),o.prototype.visitPseudoState=function(e){n.prototype.visitPseudoState.call(this,e),e.kind===t.PseudoStateKind.Choice||e.kind===t.PseudoStateKind.Junction?(0===e.outgoing.length&&t.errorTo.error(e+": "+e.kind+" pseudo states must have at least one outgoing transition."),e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length>1&&t.errorTo.error(e+": "+e.kind+" pseudo states cannot have more than one Else transitions.")):(0!==e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length&&t.errorTo.error(e+": "+e.kind+" pseudo states cannot have Else transitions."),e.isInitial()&&(1!==e.outgoing.length?t.errorTo.error(e+": initial pseudo states must have one outgoing transition."):e.outgoing[0].guard!==t.Transition.TrueGuard&&t.errorTo.error(e+": initial pseudo states cannot have a guard condition.")))},o.prototype.visitRegion=function(e){n.prototype.visitRegion.call(this,e)
var i
e.vertices.forEach(function(n){n instanceof t.PseudoState&&n.isInitial()&&(i&&t.errorTo.error(e+": regions may have at most one initial pseudo state."),i=n)})},o.prototype.visitState=function(e){n.prototype.visitState.call(this,e),e.regions.filter(function(n){return n.name===t.Region.defaultName}).length>1&&t.errorTo.error(e+": a state cannot have more than one region named "+t.Region.defaultName)},o.prototype.visitFinalState=function(e){n.prototype.visitFinalState.call(this,e),0!==e.outgoing.length&&t.errorTo.error(e+": final states must not have outgoing transitions."),0!==e.regions.length&&t.errorTo.error(e+": final states must not have child regions."),0!==e.entryBehavior.length&&t.warnTo.warn(e+": final states may not have entry behavior."),0!==e.exitBehavior.length&&t.warnTo.warn(e+": final states may not have exit behavior.")},o.prototype.visitTransition=function(i){n.prototype.visitTransition.call(this,i),i.kind===t.TransitionKind.Local&&-1===e(i.target).indexOf(i.source)&&t.errorTo.error(i+": local transition target vertices must be a child of the source composite sate.")},o}(t.Visitor)}(e||(e={}))
var n=n
