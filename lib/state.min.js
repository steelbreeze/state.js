...
var i
!function(t){function n(t,i,e){void 0===e&&(e=!0),i?(e&&t.clean===!1&&n(t),t.logTo&&t.logTo.log("initialise "+i),a(t.onInitialise,void 0,i)):(t.logTo&&t.logTo.log("initialise "+t.name),t.accept(new p,!1),t.clean=!0)}function i(t,i,e,o){return void 0===o&&(o=!0),t.logTo&&t.logTo.log(i+" evaluate "+e),o&&t.clean===!1&&n(t),i.isTerminated?!1:t.accept(h.instance,i,e)}function o(n,i){return n instanceof t.State?n.regions.every(function(t){return i.getCurrent(t).isFinal()}):!0}function r(t){u=t}function a(t,n,i,e){void 0===e&&(e=!1),t.forEach(function(t){t(n,i,e)})}function s(t,n){return t.region?s(t.region.state,n)&&n.getCurrent(t.region)===t:!0}t.initialise=n,t.evaluate=i,t.isComplete=o,t.setRandom=r
var u=function(t){return Math.floor(Math.random()*t)},c=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[]}return t}(),h=function(n){function i(){n.apply(this,arguments)}return e(i,n),i.prototype.invokeTransition=function(t,n,i){for(var e=t.traverse;t.target&&t.target.isJunction();)t=this.selectJunctionTransition(t.target,n,i),e=e.concat(t.traverse)
a(e,i,n)},i.prototype.selectJunctionTransition=function(n,i,e){var o,r
return n.transitions.forEach(function(n){if(n.guard===t.Transition.isElse){if(r)throw"Multiple outbound transitions evaluated true"
r=n}else if(n.guard(e,i)){if(o)throw"Multiple outbound transitions evaluated true"
o=n}}),o||r},i.prototype.selectChoiceTransition=function(n,i,e){var o,r=this,a=[]
return n.transitions.forEach(function(n){if(n.guard===t.Transition.isElse){if(o)throw"Multiple outbound else transitions found at "+r+" for "+e
o=n}else n.guard(e,i)&&a.push(n)}),0!==a.length?a[u(a.length)]:o},i.prototype.visitRegion=function(t,n,i){return n.getCurrent(t).accept(this,n,i)},i.prototype.visitPseudoState=function(n,i,e){var o
...
o=n.transitions[0]
break
case t.PseudoStateKind.Junction:o=this.selectJunctionTransition(n,i,e)
break
case t.PseudoStateKind.Choice:o=this.selectChoiceTransition(n,i,e)}return o?(this.invokeTransition(o,i,e),!0):!1},i.prototype.visitState=function(t,n,i){for(var e=!1,r=0,a=t.regions.length;a>r&&(!t.regions[r].accept(this,n,i)||(e=!0,s(t,n)));r++);if(!e){var u
t.transitions.forEach(function(t){if(t.guard(i,n)){if(u)throw new Error("Multiple outbound transitions evaluated true")
u=t}}),u&&(this.invokeTransition(u,n,i),e=!0)}return e&&i!==t&&o(t,n)&&this.visitState(t,n,t),e},i.instance=new i,i}(t.Visitor),f=function(n){function i(){n.apply(this,arguments)}return e(i,n),i.prototype.visitTransition=function(n,i){n.kind===t.TransitionKind.Internal?this.visitInternalTransition(n):this.visitExternalTransition(n,i)},i.prototype.visitInternalTransition=function(t){t.traverse=t.transitionBehavior},i.prototype.visitExternalTransition=function(t,n){for(var i=t.source.ancestors(),e=t.target.ancestors(),o=0,r=Math.min(i.length,e.length);r>o&&i[o]===e[o];)o++
...
this.visitVertex(n,i),n.kind!==t.PseudoStateKind.Junction&&this.behaviour(n).endEnter.push(function(t,i){o(n,i)&&n.accept(h.instance,i,n)}),n.kind===t.PseudoStateKind.Terminate&&e.beginEnter.push(function(t,n){n.isTerminated=!0}),e.enter=e.beginEnter.concat(e.endEnter)},i.prototype.visitState=function(t,n){var i=this,e=this.behaviour(t)
t.regions.forEach(function(t){var o=i.behaviour(t)
t.accept(i,n),e.leave=e.leave.concat(o.leave),e.endEnter=e.endEnter.concat(o.enter)}),this.visitVertex(t,n),this.behaviour(t).endEnter.push(function(n,i){o(t,i)&&t.accept(h.instance,i,t)}),e.leave=e.leave.concat(t.exitBehavior),e.beginEnter=e.beginEnter.concat(t.entryBehavior),e.beginEnter.push(function(n,i){t.region&&i.setCurrent(t.region,t)}),e.enter=e.beginEnter.concat(e.endEnter)},i.prototype.visitStateMachine=function(t,n){var i=this
