...
e(n.target).endEnter.invoke(o,r)})},e.prototype.visitExternalTransition=function(t,n){for(var e=u(t.source),i=u(t.target),o=Math.min(e.length,i.length)-1;e[o-1]!==i[o-1];)--o
...
t.onTraverse.push(n(t.target).endEnter)},e.prototype.cascadeElementEntry=function(n,e,i,o,r){r(e(i).beginEnter),o&&i instanceof t.State&&i.regions.forEach(function(t){r(e(t).beginEnter),t!==o.region&&r(e(t).endEnter)})},e}(t.Visitor),f=function(n){function e(){n.apply(this,arguments),this.behaviors={}}return i(e,n),e.prototype.behavior=function(t){return this.behaviors[t.qualifiedName]||(this.behaviors[t.qualifiedName]=new c)},e.prototype.visitElement=function(n){t.console!==l&&(this.behavior(n).leave.push(function(e,i){return t.console.log(i+" leave "+n)}),this.behavior(n).beginEnter.push(function(e,i){return t.console.log(i+" enter "+n)}))},e.prototype.visitRegion=function(n,e){var i=this,o=n.vertices.reduce(function(n,e){return e instanceof t.PseudoState&&e.isInitial()?e:n},void 0)
...
n.prototype.visitStateMachine.call(this,t,e),t.accept(new h,function(t){return i.behavior(t)}),t.onInitialise=this.behavior(t).enter()},e}(t.Visitor),l={log:function(){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]},warn:function(){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]},error:function(t){for(var n=[],e=1;e<arguments.length;e++)n[e-1]=arguments[e]
throw t}}
t.console=l}(e||(e={}))
var e
