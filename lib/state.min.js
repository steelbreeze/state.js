...
i.Element=h
var p=function(t){function e(e,i){t.call(this,e),this.vertices=[],this.state=i,this.state.regions.push(this),this.state.getRoot().clean=!1}return u(e,t),e.prototype.getParent=function(){return this.state},e.prototype.accept=function(t,e,i,n){return t.visitRegion(this,e,i,n)},e.defaultName="default",e}(h)
i.Region=p
var f=function(t){function e(e,i){t.call(this,e),this.transitions=[],i instanceof p?this.region=i:i instanceof v&&(this.region=i.defaultRegion()),this.region&&(this.region.vertices.push(this),this.region.getRoot().clean=!1)}return u(e,t),e.prototype.getParent=function(){return this.region},e.prototype.to=function(t){var e=new d(this,t)
return this.transitions.push(e),this.getRoot().clean=!1,e},e}(h)
i.Vertex=f
var l=function(t){function e(e,i,n){t.call(this,e,i),this.kind=n,this.isInitial()&&(this.region.initial=this)}return u(e,t),e.prototype.isHistory=function(){return this.kind===c.DeepHistory||this.kind===c.ShallowHistory},e.prototype.isInitial=function(){return this.kind===c.Initial||this.isHistory()},e.prototype.accept=function(t,e,i,n){return t.visitPseudoState(this,e,i,n)},e}(f)
i.PseudoState=l
...
return this.regions.forEach(function(e){e.name===p.defaultName&&(t=e)}),t||(t=new p(p.defaultName,this)),t},e.prototype.isFinal=function(){return 0===this.transitions.length},e.prototype.isSimple=function(){return 0===this.regions.length},e.prototype.isComposite=function(){return this.regions.length>0},e.prototype.isOrthogonal=function(){return this.regions.length>1},e.prototype.exit=function(t){return this.exitBehavior.push(t),this.getRoot().clean=!1,this},e.prototype.entry=function(t){return this.entryBehavior.push(t),this.getRoot().clean=!1,this},e.prototype.accept=function(t,e,i,n){return t.visitState(this,e,i,n)},e}(f)
i.State=v
var g=function(t){function e(e,i){t.call(this,e,i)}return u(e,t),e.prototype.to=function(){throw"A FinalState cannot be the source of a transition."},e.prototype.accept=function(t,e,i,n){return t.visitFinalState(this,e,i,n)},e}(v)
i.FinalState=g
var y=function(t){function e(e){t.call(this,e,void 0),this.clean=!1}return u(e,t),e.prototype.getRoot=function(){return this.region?this.region.getRoot():this},e.prototype.setLogger=function(t){return void 0===t&&(t=void 0),this.logger=t,this.clean=!1,this},e.prototype.accept=function(t,e,i,n){return t.visitStateMachine(this,e,i,n)},e}(v)
i.StateMachine=y
var d=function(){function t(t,e){var i=this
this.source=t,this.target=e,this.transitionBehavior=[],this.traverse=[],this.guard=function(t){return t===i.source}}return t.prototype["else"]=function(){return this.guard=t.isElse,this},t.prototype.when=function(t){return this.guard=t,this},t.prototype.effect=function(t){return this.transitionBehavior.push(t),this.source.getRoot().clean=!1,this},t.prototype.accept=function(t,e,i,n){return t.visitTransition(this,e,i,n)},t.isElse=function(){return!1},t}()
i.Transition=d
var E=function(){function t(){}return t.prototype.visitElement=function(){},t.prototype.visitRegion=function(t,e,i,n){var r=this,o=this.visitElement(t,e,i,n)
return t.vertices.forEach(function(t){t.accept(r,e,i,n)}),o},t.prototype.visitVertex=function(t,e,i,n){var r=this,o=this.visitElement(t,e,i,n)
return t.transitions.forEach(function(t){t.accept(r,e,i,n)}),o},t.prototype.visitPseudoState=function(t,e,i,n){return this.visitVertex(t,e,i,n)},t.prototype.visitState=function(t,e,i,n){var r=this,o=this.visitVertex(t,e,i,n)
return t.regions.forEach(function(t){t.accept(r,e,i,n)}),o},t.prototype.visitFinalState=function(t,e,i,n){return this.visitState(t,e,i,n)},t.prototype.visitStateMachine=function(t,e,i,n){return this.visitState(t,e,i,n)},t.prototype.visitTransition=function(){},t}()
i.Visitor=E
var m=function(){function t(t){void 0===t&&(t="unnamed"),this.name=t,this.last={},this.isTerminated=!1}return t.prototype.setCurrent=function(t,e){this.last[t.qualifiedName]=e},t.prototype.getCurrent=function(t){return this.last[t.qualifiedName]},t.prototype.toString=function(){return this.name},t}()
i.StateMachineInstance=m,i.initialise=n,i.evaluate=r,i.isComplete=o
...
t.transitions.forEach(function(t){if(t.guard===d.isElse){if(s)throw"Multiple outbound transitions evaluated true"
s=t}else if(t.guard(i,e)){if(o)throw"Multiple outbound transitions evaluated true"
o=t}}),n=o||s
break
case c.Choice:var u=[]
t.transitions.forEach(function(t){if(t.guard===d.isElse){if(s)throw"Multiple outbound else transitions found at "+r+" for "+i
...
c=t}}),c&&(a(c.traverse,i,e),n=!0)}return n&&i!==t&&o(t,e)&&this.visitState(t,e,t),n},e.instance=new e,e}(E),w=function(t){function e(){t.apply(this,arguments)}return u(e,t),e.prototype.visitTransition=function(t,e){t.target?t.target.region===t.source.region?this.visitLocalTransition(t,e):this.visitExternalTransition(t,e):this.visitInternalTransition(t,e)},e.prototype.visitInternalTransition=function(t){t.traverse=t.transitionBehavior},e.prototype.visitLocalTransition=function(t,e){t.traverse=e(t.source).leave.concat(t.transitionBehavior).concat(e(t.target).enter)},e.prototype.visitExternalTransition=function(t,e){for(var i=t.source.ancestors(),n=t.target.ancestors(),r=0,o=Math.min(i.length,n.length);o>r&&i[r]===n[r];)r++
for(t.traverse=e(r<i.length?i[r]:t.source).leave.slice(0),t.traverse=t.traverse.concat(t.transitionBehavior),r>=n.length&&(t.traverse=t.traverse.concat(e(t.target).beginEnter));r<n.length;)this.cascadeElementEntry(t,e,n[r++],r<n.length?n[r]:void 0)
t.traverse=t.traverse.concat(e(t.target).endEnter)},e.prototype.cascadeElementEntry=function(t,e,i,n){t.traverse=t.traverse.concat(e(i).beginEnter),i instanceof v&&this.cascadeOrthogonalRegionEntry(t,e,i,n)},e.prototype.cascadeOrthogonalRegionEntry=function(t,e,i,n){i.isOrthogonal()&&i.regions.forEach(function(i){i!==n&&(t.traverse=t.traverse.concat(e(i).enter))})},e}(E),R=function(t){function e(){t.apply(this,arguments),this.behaviours={}}return u(e,t),e.prototype.behaviour=function(t){return t.qualifiedName||(t.qualifiedName=t.ancestors().map(function(t){return t.name}).join(h.namespaceSeparator)),this.behaviours[t.qualifiedName]||(this.behaviours[t.qualifiedName]=new b)},e.prototype.visitElement=function(t){if(t.getRoot().logger){var e=this.behaviour(t),i=t.getRoot().logger
...
this.visitState(t,e),t.accept(new w,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter},e}(E)},{}],2:[function(t){!function(e){var i=document.currentScript
if(!i){var n=document.getElementsByTagName("script")
i=n[n.length-1]}e[i.attributes.target?i.attributes.target.textContent:"fsm"]=t("../lib/state.com.js")}(window)},{"../lib/state.com.js":1}]},{},[2])
