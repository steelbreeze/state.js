...
c=t}}),c&&(a(c.traverse,i,e),n=!0)}return n&&i!==t&&o(t,e)&&this.visitState(t,e,t),n},e.instance=new e,e}(E),w=function(t){function e(){t.apply(this,arguments)}return u(e,t),e.prototype.visitTransition=function(t,e){t.target?t.target.region===t.source.region?this.visitLocalTransition(t,e):this.visitExternalTransition(t,e):this.visitInternalTransition(t)},e.prototype.visitInternalTransition=function(t){t.traverse=t.transitionBehavior},e.prototype.visitLocalTransition=function(t,e){t.traverse=e(t.source).leave.concat(t.transitionBehavior).concat(e(t.target).enter)},e.prototype.visitExternalTransition=function(t,e){for(var i=t.source.ancestors(),n=t.target.ancestors(),r=0,o=Math.min(i.length,n.length);o>r&&i[r]===n[r];)r++
