...
1===s.length?a=r(s[0],e,i):s.length>1&&t.console.error(n+": multiple outbound transitions evaluated true for message "+i)}return a}function r(n,e,i){for(var s=new t.Behavior(n.onTraverse),u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)u=(n=a(u,e,i)).target,s.push(n.onTraverse)
return s.invoke(i,e),u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?r(a(u,e,i),e,i):u&&u instanceof t.State&&t.isComplete(u,e)&&o(u,e,u),!0}function a(n,e,i){var o=n.outgoing.filter(function(t){return t.guard(i,e)})
return n.kind===t.PseudoStateKind.Choice?0!==o.length?o[t.getRandom()(o.length)]:s(n):o.length>1?void t.console.error("Multiple outbound transition guards returned true at "+this+" for "+i):o[0]||s(n)}function s(n){return n.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard})[0]}function u(n){return new t.Behavior(n.beginEnter).push(n.endEnter)}function c(t){return(t.region?c(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=e
var h=function(){function n(){this.leave=new t.Behavior,this.beginEnter=new t.Behavior,this.endEnter=new t.Behavior}return n}(),f=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitTransition=function(n,e){n.kind===t.TransitionKind.Internal?n.onTraverse.push(n.transitionBehavior):n.kind===t.TransitionKind.Local?this.visitLocalTransition(n,e):this.visitExternalTransition(n,e)},e.prototype.visitLocalTransition=function(n,e){var i=this
n.onTraverse.push(function(o,r){for(var a=c(n.target),s=0;t.isActive(a[s],r);)++s
for(e(r.getCurrent(a[s].region)).leave.invoke(o,r),n.transitionBehavior.invoke(o,r);s<a.length;)i.cascadeElementEntry(n,e,a[s++],a[s],function(t){t.invoke(o,r)})
e(n.target).endEnter.invoke(o,r)})},e.prototype.visitExternalTransition=function(t,n){for(var e=c(t.source),i=c(t.target),o=Math.min(e.length,i.length)-1;e[o-1]!==i[o-1];)--o
...
t.onTraverse.push(n(t.target).endEnter)},e.prototype.cascadeElementEntry=function(n,e,i,o,r){r(e(i).beginEnter),o&&i instanceof t.State&&i.regions.forEach(function(t){r(e(t).beginEnter),t!==o.region&&r(e(t).endEnter)})},e}(t.Visitor),l=function(n){function e(){n.apply(this,arguments),this.behaviours={}}return i(e,n),e.prototype.behaviour=function(t){return this.behaviours[t.qualifiedName]||(this.behaviours[t.qualifiedName]=new h)},e.prototype.addLogging=function(t,n){n!==v&&(this.behaviour(t).leave.push(function(e,i){return n.log(i+" leave "+t)}),this.behaviour(t).beginEnter.push(function(e,i){return n.log(i+" enter "+t)}))},e.prototype.visitRegion=function(e,i){var o=this,r=e.vertices.reduce(function(n,e){return e instanceof t.PseudoState&&e.isInitial()?e:n},void 0)
n.prototype.visitRegion.call(this,e,i||r&&r.kind===t.PseudoStateKind.DeepHistory),this.behaviour(e).leave.push(function(t,n){return o.behaviour(n.getCurrent(e)).leave.invoke(t,n)}),this.behaviour(e).endEnter.push(i||!r||r.isHistory()?function(n,i,a){u(o.behaviour(a||r.isHistory()?i.getCurrent(e)||r:r)).invoke(n,i,a||r.kind===t.PseudoStateKind.DeepHistory)}:u(this.behaviour(r))),this.addLogging(e,t.console)},e.prototype.visitVertex=function(n){this.addLogging(n,t.console)},e.prototype.visitPseudoState=function(e,i){n.prototype.visitPseudoState.call(this,e,i),e.isInitial()?this.behaviour(e).endEnter.push(function(t,n){return r(e.outgoing[0],n)}):e.kind===t.PseudoStateKind.Terminate&&this.behaviour(e).beginEnter.push(function(t,n){return n.isTerminated=!0})},e.prototype.visitState=function(t,n){var e=this
t.regions.forEach(function(i){i.accept(e,n),e.behaviour(t).leave.push(e.behaviour(i).leave),e.behaviour(t).endEnter.push(u(e.behaviour(i)))}),this.visitVertex(t,n),this.behaviour(t).leave.push(t.exitBehavior),this.behaviour(t).beginEnter.push(t.entryBehavior),this.behaviour(t).beginEnter.push(function(n,e){t.region&&e.setCurrent(t.region,t)})},e.prototype.visitStateMachine=function(t,e){var i=this
n.prototype.visitStateMachine.call(this,t,e),t.accept(new f,function(t){return i.behaviour(t)}),t.onInitialise=u(this.behaviour(t))},e}(t.Visitor),v={log:function(){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]},warn:function(){for(var t=[],n=1;n<arguments.length;n++)t[n-1]=arguments[n]},error:function(t){for(var n=[],e=1;e<arguments.length;e++)n[e-1]=arguments[e]
throw t}}
t.console=v}(e||(e={}))
var e
