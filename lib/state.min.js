...
!function(t){var n=function(n){function e(t,e){n.call(this,t,e),this.vertices=[],this.state=e,this.state.regions.push(this),this.state.getRoot().clean=!1}return i(e,n),e.prototype.getRoot=function(){return this.state.getRoot()},e.prototype.getInitial=function(){var n
return this.vertices.forEach(function(e){e instanceof t.PseudoState&&e.isInitial()&&(n=e)}),n},e.prototype.accept=function(t,n,e,i){return t.visitRegion(this,n,e,i)},e.defaultName="default",e}(t.Element)
t.Region=n}(e||(e={}))
var e
...
var e
!function(t){function n(t,e,i){void 0===i&&(i=!0),e?(i&&t.clean===!1&&n(t),t.logTo.log("initialise "+e),t.onInitialise.forEach(function(t){return t(void 0,e)})):(t.logTo.log("initialise "+t.name),t.accept(new p,!1),t.clean=!0)}function e(t,e,i,o){return void 0===o&&(o=!0),t.logTo.log(e+" evaluate "+i),o&&t.clean===!1&&n(t),e.isTerminated?!1:r(t,e,i)}function o(t){t.accept(new f)}function r(n,e,i){var o=!1
if(n.regions.every(function(a){return r(e.getCurrent(a),e,i)&&(o=!0,!t.isActive(n,e))?!1:!0}),o)i!==n&&t.isComplete(n,e)&&r(n,e,n)
else{var s
n.outgoing.forEach(function(t){t.guard(i,e)&&(s&&n.getRoot().errorTo.error("Multiple outbound transitions evaluated true"),s=t)}),s&&(o=a(s,e,i))}return o}function a(n,e,i){for(var o=n.onTraverse,u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)u instanceof t.PseudoState&&(n=s(u,e,i)),u=n.target,Array.prototype.push.apply(o,n.onTraverse)
return o.forEach(function(t){return t(i,e)}),u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?a(s(u,e,i),e,i):u&&u instanceof t.State&&t.isComplete(u,e)&&r(u,e,u),!0}function s(n,e,i){var o=n.outgoing.filter(function(t){return t.guard(i,e)}),r=n.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard})[0]
return n.kind===t.PseudoStateKind.Choice?0!==o.length?o[t.getRandom()(o.length)]:r:o.length>1?void n.getRoot().errorTo.error("Multiple outbound transition guards returned true at "+this+" for "+i):o[0]||r}function u(t){return(t.region?u(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=e,t.validate=o
var c=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[]}return t.prototype.enter=function(){return this.beginEnter.concat(this.endEnter)},t}(),h=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitTransition=function(n,e){n.kind===t.TransitionKind.Internal?n.onTraverse=n.transitionBehavior:n.kind===t.TransitionKind.Local?this.visitLocalTransition(n,e):this.visitExternalTransition(n,e)},e.prototype.visitLocalTransition=function(n,e){var i=this
n.onTraverse.push(function(o,r){for(var a=u(n.target),s=0;t.isActive(a[s],r);)++s
for(e(r.getCurrent(a[s].region)).leave.forEach(function(t){return t(o,r)}),n.transitionBehavior.forEach(function(t){return t(o,r)});s<a.length;)i.cascadeElementEntry(n,e,a[s++],a[s],function(t){t.forEach(function(t){return t(o,r)})})
e(n.target).endEnter.forEach(function(t){return t(o,r)})})},e.prototype.visitExternalTransition=function(t,n){for(var e=u(t.source),i=u(t.target),o=Math.min(e.length,i.length)-1;e[o-1]!==i[o-1];)--o
...
Array.prototype.push.apply(t.onTraverse,n(t.target).endEnter)},e.prototype.cascadeElementEntry=function(n,e,i,o,r){r(e(i).beginEnter),o&&i instanceof t.State&&i.regions.forEach(function(t){r(e(t).beginEnter),t!==o.region&&r(e(t).endEnter)})},e}(t.Visitor),p=function(n){function e(){n.apply(this,arguments),this.behaviours={}}return i(e,n),e.prototype.behaviour=function(t){return this.behaviours[t.qualifiedName]||(this.behaviours[t.qualifiedName]=new c)},e.prototype.addLogging=function(n,e){e!==t.defaultConsole&&(this.behaviour(n).leave.push(function(t,i){return e.log(i+" leave "+n)}),this.behaviour(n).beginEnter.push(function(t,i){return e.log(i+" enter "+n)}))},e.prototype.visitRegion=function(e,i){var o=this,r=e.getInitial()
n.prototype.visitRegion.call(this,e,r&&r.kind===t.PseudoStateKind.DeepHistory),this.behaviour(e).leave.push(function(t,n){return o.behaviour(n.getCurrent(e)).leave.forEach(function(e){return e(t,n)})}),i||!r||r.isHistory()?this.behaviour(e).endEnter.push(function(n,i,a){o.behaviour(a||r.isHistory()?i.getCurrent(e)||r:r).enter().forEach(function(e){return e(n,i,a||r.kind===t.PseudoStateKind.DeepHistory)})}):Array.prototype.push.apply(this.behaviour(e).endEnter,this.behaviour(r).enter()),this.addLogging(e,e.getRoot().logTo)},e.prototype.visitVertex=function(t){this.addLogging(t,t.getRoot().logTo)},e.prototype.visitPseudoState=function(e,i){n.prototype.visitPseudoState.call(this,e,i),e.isInitial()?this.behaviour(e).endEnter.push(function(t,n){return a(e.outgoing[0],n)}):e.kind===t.PseudoStateKind.Terminate&&this.behaviour(e).beginEnter.push(function(t,n){return n.isTerminated=!0})},e.prototype.visitState=function(t,e){var i=this
n.prototype.visitState.call(this,t,e),t.regions.forEach(function(n){Array.prototype.push.apply(i.behaviour(t).leave,i.behaviour(n).leave),Array.prototype.push.apply(i.behaviour(t).endEnter,i.behaviour(n).enter())}),Array.prototype.push.apply(this.behaviour(t).leave,t.exitBehavior),Array.prototype.push.apply(this.behaviour(t).beginEnter,t.entryBehavior),this.behaviour(t).beginEnter.push(function(n,e){t.region&&e.setCurrent(t.region,t)})},e.prototype.visitStateMachine=function(t,e){var i=this
n.prototype.visitStateMachine.call(this,t,e),t.accept(new h,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter()},e}(t.Visitor),f=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitPseudoState=function(e){n.prototype.visitPseudoState.call(this,e),e.isInitial()?1!==e.outgoing.length?e.getRoot().errorTo.error(e+": initial pseudo states must have one outgoing transition."):e.outgoing[0].guard!==t.Transition.TrueGuard&&e.getRoot().errorTo.error(e+": initial pseudo states cannot have a guard condition."):(e.kind===t.PseudoStateKind.Choice||e.kind===t.PseudoStateKind.Junction)&&(0===e.outgoing.length&&e.getRoot().errorTo.error(e+": "+e.kind+" pseudo states must have at least one outgoing transition."),e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length>1&&e.getRoot().errorTo.error(e+": "+e.kind+" pseudo states cannot have more than one Else transitions."))},e.prototype.visitRegion=function(e){n.prototype.visitRegion.call(this,e)
var i
e.vertices.forEach(function(n){n instanceof t.PseudoState&&n.isInitial()&&(i&&e.getRoot().errorTo.error(e+": regions may have at most one initial pseudo state."),i=n)})},e.prototype.visitFinalState=function(t){n.prototype.visitFinalState.call(this,t),0!==t.outgoing.length&&t.getRoot().errorTo.error(t+": final states must not have outgoing transitions."),0!==t.regions.length&&t.getRoot().errorTo.error(t+": final states must not have child regions."),0!==t.entryBehavior.length&&t.getRoot().warnTo.warn(t+": final states may not have entry behavior."),0!==t.exitBehavior.length&&t.getRoot().warnTo.warn(t+": final states may not have exit behavior.")},e.prototype.visitTransition=function(e){n.prototype.visitTransition.call(this,e),e.kind===t.TransitionKind.Local&&-1===u(e.target).indexOf(e.source)&&e.source.getRoot().errorTo.error(e+": local transition target vertices must be a child of the source composite sate.")},e}(t.Visitor)}(e||(e={}))
var n=n
