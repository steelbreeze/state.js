...
var n
!function(t){function e(t,n,i){void 0===i&&(i=!0),n?(i&&t.clean===!1&&e(t),t.logTo.log("initialise "+n),t.onInitialise.forEach(function(t){return t(void 0,n)})):(t.logTo.log("initialise "+t.name),t.accept(new f,!1),t.clean=!0)}function n(t,n,i,o){return void 0===o&&(o=!0),t.logTo.log(n+" evaluate "+i),o&&t.clean===!1&&e(t),n.isTerminated?!1:r(t,n,i)}function o(t){t.accept(new p)}function r(e,n,i){var o=!1
...
return e.outgoing.forEach(function(s){s.guard===t.Transition.FalseGuard?(o&&e.getRoot().errorTo.error("Multiple outbound else transitions found at "+r+" for "+i),o=s):s.guard(i,n)&&a.push(s)}),e.kind===t.PseudoStateKind.Choice?0!==a.length?a[t.getRandom()(a.length)]:o:e.kind===t.PseudoStateKind.Junction?(a.length>1&&e.getRoot().errorTo.error("Multiple outbound transition guards returned true at "+this+" for "+i),a[0]||o):void 0}function u(t){return(t.region?u(t.region.state):[]).concat(t)}t.initialise=e,t.evaluate=n,t.validate=o
var c=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[]}return t.prototype.enter=function(){return this.beginEnter.concat(this.endEnter)},t}(),h=function(e){function n(){e.apply(this,arguments)}return i(n,e),n.prototype.visitTransition=function(e,n){e.kind===t.TransitionKind.Internal?e.onTraverse=e.transitionBehavior:e.kind===t.TransitionKind.Local?this.visitLocalTransition(e,n):this.visitExternalTransition(e,n)},n.prototype.visitLocalTransition=function(e,n){var i=this
e.onTraverse.push(function(o,r){for(var a=u(e.target),s=0;t.isActive(a[s],r);)++s
for(n[r.getCurrent(a[s].region).qualifiedName].leave.forEach(function(t){return t(o,r)}),e.transitionBehavior.forEach(function(t){return t(o,r)});s<a.length;)i.cascadeElementEntry(e,n,a[s++],a[s],function(t){t.forEach(function(t){return t(o,r)})})
