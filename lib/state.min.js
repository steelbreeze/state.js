...
var c=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[]}return t.prototype.enter=function(){return this.beginEnter.concat(this.endEnter)},t}(),h=function(e){function n(){e.apply(this,arguments)}return i(n,e),n.prototype.visitTransition=function(e,n){switch(e.kind){case t.TransitionKind.Internal:e.onTraverse=e.transitionBehavior
break
...
for(n[r.getCurrent(a[s].region).qualifiedName].leave.forEach(function(t){return t(o,r)}),e.transitionBehavior.forEach(function(t){return t(o,r)});s<a.length;)i.cascadeElementEntry(e,n,a[s++],s<a.length?a[s]:void 0,function(t){t.forEach(function(t){return t(o,r)})})
...
this.visitVertex(e,n),e.isInitial()?this.behaviour(e).endEnter.push(function(t,n){return a(e.outgoing[0],n)}):e.kind===t.PseudoStateKind.Terminate&&i.beginEnter.push(function(t,e){return e.isTerminated=!0})},n.prototype.visitState=function(t,e){var n=this,i=this.behaviour(t)
