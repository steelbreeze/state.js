...
throw c.code="MODULE_NOT_FOUND",c}var h=i[s]={exports:{}}
e[s][0].call(h.exports,function(t){var i=e[s][1][t]
return r(i?i:t)},h,h.exports,t,e,i,n)}return i[s].exports}for(var o="function"==typeof require&&require,s=0;s<n.length;s++)r(n[s])
return r}({1:[function(t,e,i){function n(t,e,i){void 0===i&&(i=!0),e?(i&&t.clean===!1&&n(t),t.logger&&t.logger.log("initialise "+e),s(t.onInitialise,void 0,e)):(t.logger&&t.logger.log("initialise "+t.name),t.accept(new R,!1),t.clean=!0)}function r(t,e,i,r){return void 0===r&&(r=!0),t.logger&&t.logger.log(e+" evaluate "+i),r&&t.clean===!1&&n(t),e.isTerminated?!1:t.accept(S.instance,e,i)}function o(t,e){return t instanceof v?t.regions.every(function(t){return e.getCurrent(t).isFinal()}):!0}function s(t,e,i,n){void 0===n&&(n=!1),t.forEach(function(t){t(e,i,n)})}function a(t,e){return t.region?a(t.region.state,e)&&e.getCurrent(t.region)===t:!0}var u=this.__extends||function(t,e){function i(){this.constructor=t}for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n])
...
i.Transition=y
var m=function(){function t(){}return t.prototype.visitElement=function(){},t.prototype.visitRegion=function(t,e,i,n,r){var o=this,s=this.visitElement(t,e,i,n,r)
return t.vertices.forEach(function(t){t.accept(o,e,i,n,r)}),s},t.prototype.visitVertex=function(t,e,i,n,r){var o=this,s=this.visitElement(t,e,i,n,r)
return t.transitions.forEach(function(t){t.accept(o,e,i,n,r)}),s},t.prototype.visitPseudoState=function(t,e,i,n,r){return this.visitVertex(t,e,i,n,r)},t.prototype.visitState=function(t,e,i,n,r){var o=this,s=this.visitVertex(t,e,i,n,r)
return t.regions.forEach(function(t){t.accept(o,e,i,n,r)}),s},t.prototype.visitFinalState=function(t,e,i,n,r){return this.visitState(t,e,i,n,r)},t.prototype.visitStateMachine=function(t,e,i,n,r){return this.visitState(t,e,i,n,r)},t.prototype.visitTransition=function(){},t}()
i.Visitor=m
...
a=t}else if(t.guard(i,e)){if(o)throw"Multiple outbound transitions evaluated true"
o=t}}),n=o||a
break
case c.Choice:var u=[]
t.transitions.forEach(function(t){if(t.guard===y.isElse){if(a)throw"Multiple outbound else transitions found at "+r+" for "+i
a=t}else t.guard(i,e)&&u.push(t)}),n=0!==u.length?u[Math.round((u.length-1)*Math.random())]:a}return n?(s(n.traverse,i,e),!0):!1},e.prototype.visitState=function(t,e,i){for(var n=!1,r=0,u=t.regions.length;u>r&&(!t.regions[r].accept(this,e,i)||(n=!0,a(t,e)));r++);if(!n){var c
t.transitions.forEach(function(t){if(t.guard(i,e)){if(c)throw new Error("Multiple outbound transitions evaluated true")
c=t}}),c&&(s(c.traverse,i,e),n=!0)}return n&&i!==t&&o(t,e)&&this.visitState(t,e,t),n},e.instance=new e,e}(m),w=function(t){function e(){t.apply(this,arguments)}return u(e,t),e.prototype.visitTransition=function(t,e){if(t.target)if(t.target.region===t.source.region)t.traverse=e(t.source).leave.concat(t.transitionBehavior).concat(e(t.target).enter)
else{for(var i=t.source.ancestors(),n=t.target.ancestors(),r=i.length,o=n.length,s=0,a=Math.min(r,o);a>s&&i[s]===n[s];)s++
if(i[s]instanceof f)throw"Transitions may not cross sibling orthogonal region boundaries"
for(t.traverse=e(r>s?i[s]:t.source).leave.slice(0),t.traverse=t.traverse.concat(t.transitionBehavior),s>=o&&(t.traverse=t.traverse.concat(e(t.target).beginEnter));o>s;){var u=n[s++],c=o>s?n[s]:void 0
...
t.vertices.forEach(function(n){n.accept(i,e||t.initial&&t.initial.kind===c.DeepHistory)}),n.leave.push(function(e,n){s(i.behaviour(n.getCurrent(t)).leave,e,n)}),e||!t.initial||t.initial.isHistory()?n.endEnter.push(function(e,n,r){var o=t.initial;(r||t.initial.isHistory())&&(o=n.getCurrent(t)||t.initial),s(i.behaviour(o).enter,e,n,r||t.initial.kind===c.DeepHistory)}):n.endEnter=n.endEnter.concat(this.behaviour(t.initial).enter),this.visitElement(t,e),n.enter=n.beginEnter.concat(n.endEnter)},e.prototype.visitVertex=function(t,e){this.visitElement(t,e),this.behaviour(t).endEnter.push(function(e,i){o(t,i)&&t.accept(S.instance,i,t)})},e.prototype.visitPseudoState=function(t,e){var i=this.behaviour(t)
...
this.visitState(t,e),t.accept(new w,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter},e}(m)},{}],2:[function(t){!function(e){var i=document.currentScript||function(){var t=document.getElementsByTagName("script")
return t[t.length-1]}(),n=i.attributes["class"]
e[n?n.textContent:"fsm"]=t("../lib/state.com.js")}(window)},{"../lib/state.com.js":1}]},{},[2])
