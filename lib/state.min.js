...
1===s.length?a=r(s[0],e,i):s.length>1&&n.getRoot().errorTo.error(n+": multiple outbound transitions evaluated true for message "+i)}return a}function r(n,e,i){for(var s=n.onTraverse,u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)u=(n=a(u,e,i)).target,Array.prototype.push.apply(s,n.onTraverse)
return s.forEach(function(t){return t(i,e)}),u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?r(a(u,e,i),e,i):u&&u instanceof t.State&&t.isComplete(u,e)&&o(u,e,u),!0}function a(n,e,i){var o=n.outgoing.filter(function(t){return t.guard(i,e)})
return n.kind===t.PseudoStateKind.Choice?0!==o.length?o[t.getRandom()(o.length)]:s(n):o.length>1?void n.getRoot().errorTo.error("Multiple outbound transition guards returned true at "+this+" for "+i):o[0]||s(n)}function s(n){return n.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard})[0]}function u(t){return(t.region?u(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=e
...
n.prototype.visitStateMachine.call(this,t,e),t.accept(new h,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter()},e}(t.Visitor)}(e||(e={}))
var e
...
var i
e.vertices.forEach(function(n){n instanceof t.PseudoState&&n.isInitial()&&(i&&e.getRoot().errorTo.error(e+": regions may have at most one initial pseudo state."),i=n)})},o.prototype.visitFinalState=function(t){n.prototype.visitFinalState.call(this,t),0!==t.outgoing.length&&t.getRoot().errorTo.error(t+": final states must not have outgoing transitions."),0!==t.regions.length&&t.getRoot().errorTo.error(t+": final states must not have child regions."),0!==t.entryBehavior.length&&t.getRoot().warnTo.warn(t+": final states may not have entry behavior."),0!==t.exitBehavior.length&&t.getRoot().warnTo.warn(t+": final states may not have exit behavior.")},o.prototype.visitTransition=function(i){n.prototype.visitTransition.call(this,i),i.kind===t.TransitionKind.Local&&-1===e(i.target).indexOf(i.source)&&i.source.getRoot().errorTo.error(i+": local transition target vertices must be a child of the source composite sate.")},o}(t.Visitor)}(e||(e={}))
var n=n
