...
t.Vertex=e}(n||(n={}))
var n
!function(t){var e=function(e){function n(t,n,i){e.call(this,t,n),this.kind=i,this.isInitial()&&(this.region.initial=this)}return i(n,e),n.prototype.isHistory=function(){return this.kind===t.PseudoStateKind.DeepHistory||this.kind===t.PseudoStateKind.ShallowHistory},n.prototype.isInitial=function(){return this.kind===t.PseudoStateKind.Initial||this.isHistory()},n.prototype.accept=function(t,e,n,i){return t.visitPseudoState(this,e,n,i)},n}(t.Vertex)
t.PseudoState=e}(n||(n={}))
var n
...
t.Transition=e
var n=function(){function t(){}return t.prototype.visitElement=function(){},t.prototype.visitRegion=function(t,e,n,i){var r=this,o=this.visitElement(t,e,n,i)
...
this.visitVertex(e,n),e.kind===t.PseudoStateKind.Terminate&&i.enter.push(function(t,e){e.isTerminated=!0}),i.enter=i.beginEnter.concat(i.endEnter)},n.prototype.visitState=function(t,e){var n=this,i=this.behaviour(t)
