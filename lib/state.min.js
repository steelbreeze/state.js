...
var e
!function(t){function n(t,e,i){void 0===i&&(i=!0),e?(i&&t.clean===!1&&n(t),t.logTo.log("initialise "+e),t.onInitialise.forEach(function(t){return t(void 0,e)})):(t.logTo.log("initialise "+t.name),t.accept(new f,!1),t.clean=!0)}function e(t,e,i,o){return void 0===o&&(o=!0),t.logTo.log(e+" evaluate "+i),o&&t.clean===!1&&n(t),e.isTerminated?!1:r(t,e,i)}function o(t){t.accept(new l)}function r(n,e,i){var o=!1
...
return o.forEach(function(t){return t(i,e)}),u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?a(s(u,e,i),e,i):u&&u instanceof t.State&&t.isComplete(u,e)&&r(u,e,u),!0}function s(n,e,i){var o=n.outgoing.filter(function(t){return t.guard(i,e)})
return n.kind===t.PseudoStateKind.Choice?0!==o.length?o[t.getRandom()(o.length)]:u(n):o.length>1?void n.getRoot().errorTo.error("Multiple outbound transition guards returned true at "+this+" for "+i):o[0]||u(n)}function u(n){return n.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard})[0]}function c(t){return(t.region?c(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=e,t.validate=o
var h=function(){function t(){this.leave=[],this.beginEnter=[],this.endEnter=[]}return t.prototype.enter=function(){return this.beginEnter.concat(this.endEnter)},t}(),p=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitTransition=function(n,e){n.kind===t.TransitionKind.Internal?n.onTraverse=n.transitionBehavior:n.kind===t.TransitionKind.Local?this.visitLocalTransition(n,e):this.visitExternalTransition(n,e)},e.prototype.visitLocalTransition=function(n,e){var i=this
n.onTraverse.push(function(o,r){for(var a=c(n.target),s=0;t.isActive(a[s],r);)++s
...
e(n.target).endEnter.forEach(function(t){return t(o,r)})})},e.prototype.visitExternalTransition=function(t,n){for(var e=c(t.source),i=c(t.target),o=Math.min(e.length,i.length)-1;e[o-1]!==i[o-1];)--o
...
Array.prototype.push.apply(t.onTraverse,n(t.target).endEnter)},e.prototype.cascadeElementEntry=function(n,e,i,o,r){r(e(i).beginEnter),o&&i instanceof t.State&&i.regions.forEach(function(t){r(e(t).beginEnter),t!==o.region&&r(e(t).endEnter)})},e}(t.Visitor),f=function(n){function e(){n.apply(this,arguments),this.behaviours={}}return i(e,n),e.prototype.behaviour=function(t){return this.behaviours[t.qualifiedName]||(this.behaviours[t.qualifiedName]=new h)},e.prototype.addLogging=function(n,e){e!==t.defaultConsole&&(this.behaviour(n).leave.push(function(t,i){return e.log(i+" leave "+n)}),this.behaviour(n).beginEnter.push(function(t,i){return e.log(i+" enter "+n)}))},e.prototype.visitRegion=function(e,i){var o=this,r=e.getInitial()
...
n.prototype.visitStateMachine.call(this,t,e),t.accept(new p,function(t){return i.behaviour(t)}),t.onInitialise=this.behaviour(t).enter()},e}(t.Visitor),l=function(n){function e(){n.apply(this,arguments)}return i(e,n),e.prototype.visitPseudoState=function(e){n.prototype.visitPseudoState.call(this,e),e.kind===t.PseudoStateKind.Choice||e.kind===t.PseudoStateKind.Junction?(0===e.outgoing.length&&e.getRoot().errorTo.error(e+": "+e.kind+" pseudo states must have at least one outgoing transition."),e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length>1&&e.getRoot().errorTo.error(e+": "+e.kind+" pseudo states cannot have more than one Else transitions.")):(0!==e.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard}).length&&e.getRoot().errorTo.error(e+": "+e.kind+" pseudo states cannot have Else transitions."),e.isInitial()&&(1!==e.outgoing.length?e.getRoot().errorTo.error(e+": initial pseudo states must have one outgoing transition."):e.outgoing[0].guard!==t.Transition.TrueGuard&&e.getRoot().errorTo.error(e+": initial pseudo states cannot have a guard condition.")))},e.prototype.visitRegion=function(e){n.prototype.visitRegion.call(this,e)
var i
e.vertices.forEach(function(n){n instanceof t.PseudoState&&n.isInitial()&&(i&&e.getRoot().errorTo.error(e+": regions may have at most one initial pseudo state."),i=n)})},e.prototype.visitFinalState=function(t){n.prototype.visitFinalState.call(this,t),0!==t.outgoing.length&&t.getRoot().errorTo.error(t+": final states must not have outgoing transitions."),0!==t.regions.length&&t.getRoot().errorTo.error(t+": final states must not have child regions."),0!==t.entryBehavior.length&&t.getRoot().warnTo.warn(t+": final states may not have entry behavior."),0!==t.exitBehavior.length&&t.getRoot().warnTo.warn(t+": final states may not have exit behavior.")},e.prototype.visitTransition=function(e){n.prototype.visitTransition.call(this,e),e.kind===t.TransitionKind.Local&&-1===c(e.target).indexOf(e.source)&&e.source.getRoot().errorTo.error(e+": local transition target vertices must be a child of the source composite sate.")},e}(t.Visitor)}(e||(e={}))
var n=n
