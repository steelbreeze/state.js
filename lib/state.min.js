...
h(i(n.target)).invoke(o,r)})},i.prototype.visitExternalTransition=function(t,n){for(var i=l(t.source),e=l(t.target),o=Math.min(i.length,e.length)-1;i[o-1]!==e[o-1];)--o
