...
return s.invoke(i,e),u&&(u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Choice?r(a(u,e,i),e,i):u instanceof t.State&&t.isComplete(u,e)&&o(u,e,u)),!0}function a(n,e,i){var o=n.outgoing.filter(function(t){return t.guard(i,e)})
return n.kind===t.PseudoStateKind.Choice?0!==o.length?o[t.getRandom()(o.length)]:s(n):o.length>1?void t.console.error("Multiple outbound transition guards returned true at "+n+" for "+i):o[0]||s(n)}function s(n){return n.outgoing.filter(function(n){return n.guard===t.Transition.FalseGuard})[0]}function u(t){return(t.region?u(t.region.state):[]).concat(t)}t.initialise=n,t.evaluate=e
