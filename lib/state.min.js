...
n.outgoing.forEach(function(t){t.guard(i,e)&&(s&&n.getRoot().errorTo.error("Multiple outbound transitions evaluated true"),s=t)}),s&&(a=r(s,e,i))}return a}function r(n,e,i){for(var s=n.onTraverse,u=n.target;u&&u instanceof t.PseudoState&&u.kind===t.PseudoStateKind.Junction;)u instanceof t.PseudoState&&(n=a(u,e,i)),u=n.target,Array.prototype.push.apply(s,n.onTraverse)
