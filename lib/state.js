...
(function (StateJS) {
     ...
     */
    function initialise(stateMachineModel, instance, autoInitialiseModel) {
     ...
     */
    function evaluate(stateMachineModel, instance, message, autoInitialiseModel) {
        if (autoInitialiseModel === void 0) { autoInitialiseModel = true; }
        // log as required
    ...
    function traverse(transition, instance, message) {
        ...
        while (target && target instanceof StateJS.PseudoState && target.kind === StateJS.PseudoStateKind.Junction) {
            target = (transition = selectTransition(target, instance, message)).target; // TODO: fix cast
