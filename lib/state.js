    ...
    var InitialiseElements = (function (_super) {
        ...
        InitialiseElements.prototype.visitElement = function (element, deepHistoryAbove) {
            ...
            if (logger) {
                ...
                elementBehaviour.leave.push(function (message, instance) { return logger.log(instance + " leave " + element); });
                elementBehaviour.beginEnter.push(function (message, instance) { return logger.log(instance + " enter " + element); });
            }
        };
