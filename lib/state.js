...
var Vertex = (function (_super) {
    ...
    function Vertex(name, parent) {
        _super.call(this, name, parent instanceof State ? parent.defaultRegion() : parent); // TODO: find a cleaner way to manage implicit conversion
        /**
...
var State = (function (_super) {
    ...
    function State(name, parent) {
        ...
        /* internal */ this.exitBehavior = new Behavior();
        // user defined behavior (via entry method) to execute when entering a state.
        /* internal */ this.entryBehavior = new Behavior();
        /**
...
var Transition = (function () {
    ...
    function Transition(source, target, kind) {
        ...
        /*internal*/ this.transitionBehavior = new Behavior();
        this.source = source;
        this.target = target;
...
var ElementBehavior = (function () {
    function ElementBehavior() {
        this.leave = new Behavior();
        this.beginEnter = new Behavior();
        this.endEnter = new Behavior();
    }
...
var InitialiseElements = (function (_super) {
    ...
    InitialiseElements.prototype.visitElement = function (element, deepHistoryAbove) {
        if (exports.console !== defaultConsole) {
            this.behavior(element).leave.push(function (message, instance) { return exports.console.log(instance + " leave " + element); });
    ...
    InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        region.vertices.forEach(function (vertex) { return vertex.accept(_this, deepHistoryAbove || (regionInitial && regionInitial.kind === PseudoStateKind.DeepHistory)); });
