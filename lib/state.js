...
var InitialiseElements = (function (_super) {
    ...
    InitialiseElements.prototype.behavior = function (vertexOrRegion) {
        return this.behaviors[vertexOrRegion.toString()] || (this.behaviors[vertexOrRegion.toString()] = new Behavior());
    };
    InitialiseElements.prototype.visitElement = function (vertexOrRegion, deepHistoryAbove) {
        if (exports.console !== defaultConsole) {
            this.behavior(vertexOrRegion).leave.push(function (message, instance) { return exports.console.log(instance + " enter " + vertexOrRegion); });
            this.behavior(vertexOrRegion).beginEnter.push(function (message, instance) { return exports.console.log(instance + " enter " + vertexOrRegion); });
        }
    };
