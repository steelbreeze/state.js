...
(function (StateJS) {
    ...
    var Transition = (function () {
         ...
         */
        function Transition(source, target /*, kind: TransitionKind = TransitionKind.External*/) {
            var _this = this;
            this.source = source;
            this.target = target;
            ...
            this.kind = target ? StateJS.TransitionKind.External : StateJS.TransitionKind.Internal;
...
(function (StateJS) {
    ...
    function selectChoiceTransition(vertex, stateMachineInstance, message) {
        ...
        vertex.transitions.forEach(function (t) {
            if (t.guard === StateJS.Transition.isElse) {
                if (elseResult) {
                    if (vertex.getRoot().errorTo) {
                        vertex.getRoot().errorTo.error(vertex.getRoot(), "Multiple outbound else transitions found at " + _this + " for " + message);
                    }
                }
                elseResult = t;
            }
    ...
    var Evaluator = (function (_super) {
        ...
        Evaluator.prototype.visitState = function (state, stateMachineInstance, message) {
            ...
            if (result && (message !== state) && StateJS.isComplete(state, stateMachineInstance)) {
    ...
    var InitialiseElements = (function (_super) {
        ...
        InitialiseElements.prototype.behaviour = function (element) {
            if (!element.qualifiedName) {
                element.qualifiedName = element.getAncestors().map(function (e) { return e.name; }).join(StateJS.Element.namespaceSeparator);
            }
        ...
        InitialiseElements.prototype.visitPseudoState = function (pseudoState, deepHistoryAbove) {
            ...
            if (pseudoState.isInitial()) {
                this.behaviour(pseudoState).endEnter.push(function (message, stateMachineInstance) {
                    if (StateJS.isComplete(pseudoState, stateMachineInstance)) {
        ...
        InitialiseElements.prototype.visitState = function (state, deepHistoryAbove) {
            ...
            // evaluate comppletion transitions once vertex entry is complete
            this.behaviour(state).endEnter.push(function (message, stateMachineInstance) {
                if (StateJS.isComplete(state, stateMachineInstance)) {
