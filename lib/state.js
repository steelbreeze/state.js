    ...
    var InitialiseTransitions = (function (_super) {
        ...
        InitialiseTransitions.prototype.visitLocalTransition = function (transition, behaviour) {
            ...
            transition.onTraverse.push(function (message, instance) {
                ...
                if (sibling instanceof StateJS.Vertex) {
                    behaviour[instance.getCurrent(sibling.region).qualifiedName].leave.forEach(function (action) { return action(message, instance); });
                }
                else if (sibling instanceof StateJS.Region) {
                    behaviour[instance.getCurrent(sibling).qualifiedName].leave.forEach(function (action) { return action(message, instance); });
                }
