...
(function (StateJS) {
    ...
    var InitialiseElements = (function (_super) {
        ...
        InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
            ...
            _super.prototype.visitRegion.call(this, region, regionInitial && regionInitial.kind === StateJS.PseudoStateKind.DeepHistory);
            ...
            if (region.getRoot().logTo !== StateJS.defaultConsole) {
                this.behaviour(region).leave.push(function (message, instance) { return region.getRoot().logTo.log(instance + " leave " + region); });
                this.behaviour(region).beginEnter.push(function (message, instance) { return region.getRoot().logTo.log(instance + " enter " + region); });
            }
        };
        InitialiseElements.prototype.visitVertex = function (vertex, deepHistoryAbove) {
            if (vertex.getRoot().logTo !== StateJS.defaultConsole) {
                this.behaviour(vertex).leave.push(function (message, instance) { return vertex.getRoot().logTo.log(instance + " leave " + vertex); });
                this.behaviour(vertex).beginEnter.push(function (message, instance) { return vertex.getRoot().logTo.log(instance + " enter " + vertex); });
            }
        };
        ...
        InitialiseElements.prototype.visitState = function (state, deepHistoryAbove) {
            var _this = this;
            _super.prototype.visitState.call(this, state, deepHistoryAbove);
