    ...
    var InitialiseElements = (function (_super) {
        ...
        InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
            ...
            if (deepHistoryAbove || !regionInitial || regionInitial.isHistory()) {
                this.behaviour(region).endEnter.push(function (message, stateMachineInstance, history) {
                    (_this.behaviour((history || regionInitial.isHistory()) ? stateMachineInstance.getCurrent(region) || regionInitial : regionInitial)).enter().invoke(message, stateMachineInstance, history || regionInitial.kind === StateJS.PseudoStateKind.DeepHistory);
                });
            }
            else {
        ...
        InitialiseElements.prototype.visitState = function (state, deepHistoryAbove) {
            ...
            state.regions.forEach(function (region) {
                ...
                _this.behaviour(state).endEnter.push(_this.behaviour(region).enter());
            });
