...
(function (fsm) {
    ...
    function isActive(state, instance) {
    ...
    function isComplete(vertex, instance) {
        if (vertex instanceof fsm.State) {
            return vertex.regions.every(function (region) { return instance.getCurrent(region).isFinal(); });
        }
        return true;
    }
