...
(function (fsm) {
    ...
    var Evaluator = (function (_super) {
        ...
        Evaluator.prototype.visitRegion = function (region, instance, message) {
            ...
            return this.visitState(instance.getCurrent(region), instance, message);
        };
        Evaluator.prototype.select = function (pseudoState, message, instance) {
            var transition;
        ...
        Evaluator.prototype.visitState = function (state, instance, message) {
            ...
            for (var i = 0, l = state.regions.length; i < l; i++) {
                if (state.isActive(instance)) {
                    if (this.visitRegion(state.regions[i], instance, message)) {
                        result = true;
                    }
                }
            }
