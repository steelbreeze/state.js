...
return this.transitions.push(i),this.root().clean=!1,i},i.prototype.accept=function(){for(var t=[],e=2;e<arguments.length;e++)t[e-2]=arguments[e]},i}(t.Element)
t.Vertex=e}(fsm||(fsm={}))
var fsm
...
r=e.transitions[0]
break
case t.PseudoStateKind.Junction:for(var o,s,a=0,u=e.transitions.length;u>a;a++)if(e.transitions[a].guard===t.Transition.isElse){if(s)throw"Multiple outbound transitions evaluated true"
s=e.transitions[a]}else if(e.transitions[a].guard(i,n)){if(o)throw"Multiple outbound transitions evaluated true"
o=e.transitions[a]}r=o||s
break
case t.PseudoStateKind.Choice:for(var c=[],a=0,u=e.transitions.length;u>a;a++)if(e.transitions[a].guard===t.Transition.isElse){if(s)throw"Multiple outbound else transitions found at "+this+" for "+i
s=e.transitions[a]}else e.transitions[a].guard(i,n)&&c.push(e.transitions[a])
r=0!==c.length?c[Math.round((c.length-1)*Math.random())]:s}return r},n.prototype.visitPseudoState=function(t,i,n){var r=this.select(t,n,i)
return r?(e(r.traverse,n,i),!0):!1},n.prototype.visitState=function(t,i,n){for(var r=!1,o=0,s=t.regions.length;s>o;o++)t.isActive(i)&&this.visitRegion(t.regions[o],i,n)&&(r=!0)
if(!r){for(var a,o=0,s=t.transitions.length;s>o;o++)if(t.transitions[o].guard(n,i)){if(a)throw new Error("Multiple outbound transitions evaluated true")
