...
o=n.transitions[0]
break
case t.PseudoStateKind.Junction:for(var s,a,u=0,c=n.transitions.length;c>u;u++)if(n.transitions[u].guard===t.Transition.isElse){if(a)throw"Multiple outbound transitions evaluated true"
a=n.transitions[u]}else if(n.transitions[u].guard(r,i)){if(s)throw"Multiple outbound transitions evaluated true"
s=n.transitions[u]}o=s||a
break
case t.PseudoStateKind.Choice:for(var h=[],u=0,c=n.transitions.length;c>u;u++)if(n.transitions[u].guard===t.Transition.isElse){if(a)throw"Multiple outbound else transitions found at "+this+" for "+r
a=n.transitions[u]}else n.transitions[u].guard(r,i)&&h.push(n.transitions[u])
o=0!==h.length?h[Math.round((h.length-1)*Math.random())]:a}return o?(e(o.traverse,r,i),!0):!1},o.prototype.visitState=function(t,r,o){for(var s=!1,a=0,u=t.regions.length;u>a&&(!t.regions[a].accept(this,r,o)||(s=!0,n(t,r)));a++);if(!s){for(var c,a=0,u=t.transitions.length;u>a;a++)if(t.transitions[a].guard(o,r)){if(c)throw new Error("Multiple outbound transitions evaluated true")
c=t.transitions[a]}c&&(e(c.traverse,o,r),s=!0)}return s&&o!==t&&i(t,r)&&this.visitState(t,r,t),s},o}(t.Visitor),a=function(e){function n(){e.apply(this,arguments)}return __extends(n,e),n.getInstance=function(){return n._instance||(n._instance=new n),n._instance},n.prototype.visitTransition=function(e,n){if(e.target)if(e.target.getParent()===e.source.getParent())e.traverse=n(e.source).leave.concat(e.transitionBehavior).concat(n(e.target).enter)
...
l!==h&&(e.traverse=e.traverse.concat(n(l).enter))}}}e.traverse=e.traverse.concat(n(e.target).endEnter)}else e.traverse=e.transitionBehavior},n}(t.Visitor),u=function(n){function r(){n.apply(this,arguments),this.behaviours={}}return __extends(r,n),r.getInstance=function(){return r._instance||(r._instance=new r),r._instance},r.prototype.behaviour=function(e){return e.qualifiedName||(e.qualifiedName=e.ancestors().map(function(t){return t.name}).join(t.Element.namespaceSeparator)),this.behaviours[e.qualifiedName]||(this.behaviours[e.qualifiedName]=new o)},r.prototype.visitElement=function(t){var e=this.behaviour(t)
e.enter=e.beginEnter.concat(e.endEnter)},r.prototype.visitRegion=function(n,i){for(var r=this,o=this.behaviour(n),s=0,a=n.vertices.length;a>s;s++)n.vertices[s].accept(this,i||n.initial&&n.initial.kind===t.PseudoStateKind.DeepHistory)
o.leave.push(function(t,i){e(r.behaviour(i.getCurrent(n)).leave,t,i)}),i||!n.initial||n.initial.isHistory()?o.endEnter.push(function(i,o,s){var a=n.initial;(s||n.initial.isHistory())&&(a=o.getCurrent(n)||n.initial),e(r.behaviour(a).enter,i,o,s||n.initial.kind===t.PseudoStateKind.DeepHistory)}):o.endEnter=o.endEnter.concat(this.behaviour(n.initial).enter),this.visitElement(n,i)},r.prototype.visitVertex=function(t,e){this.visitElement(t,e)
var n=this.behaviour(t)
n.endEnter.push(function(e,n){i(t,n)&&t.accept(s.getInstance(),n,t)}),n.enter=n.beginEnter.concat(n.endEnter)},r.prototype.visitPseudoState=function(e,n){this.visitVertex(e,n),e.kind===t.PseudoStateKind.Terminate&&this.behaviour(e).enter.push(function(t,e){e.isTerminated=!0})},r.prototype.visitState=function(t,n){for(var i=this.behaviour(t),r=0,o=t.regions.length;o>r;r++){var s=t.regions[r],a=this.behaviour(s)
s.accept(this,n),i.leave.push(function(t,n){e(a.leave,t,n)}),i.endEnter=i.endEnter.concat(a.enter)}this.visitVertex(t,n),i.leave=i.leave.concat(t.exitBehavior),i.beginEnter=i.beginEnter.concat(t.entryBehavior),i.beginEnter.push(function(e,n){t.region&&n.setCurrent(t.region,t)}),i.enter=i.beginEnter.concat(i.endEnter)},r.prototype.visitStateMachine=function(t,e){var n=this
