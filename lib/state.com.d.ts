...
export declare abstract class NamedElement {
     ...
     */
    constructor(name: string, parent: NamedElement);
    /**
     * Returns the [[NamedElement]] [[name]] as a namespace delimited by [[namespaceSeparator]].
     */
    toString(): string;
...
export declare abstract class Visitor<TArg1> {
     ...
     */
    visitElement(namedElement: NamedElement, arg1?: TArg1, arg2?: any, arg3?: any): any;
    /**
 ...
 * @param instance The state machine instance.
 */
export declare function isComplete(regionOrState: Region | State, instance: IInstance): boolean;
/**
