 ...
 */
export declare function ancestors<TNode extends IChild<TNode>>(node: TNode): Array<TNode>;
/**
 ...
 */
export declare function lowestCommonAncestorIndex<TNode extends IChild<TNode>>(ancestry1: Array<TNode>, ancestry2: Array<TNode>): number;
/**
 ...
 */
export declare function isChild<TNode extends IChild<TNode>>(child: TNode, parent: TNode): boolean;
/**
 ...
 */
export declare function depth<TNode extends IChild<TNode>>(node: TNode): number;
