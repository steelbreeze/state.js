    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (message !== state) {
            ...
            for (let region in state.regions) {
                ...
                if (currentState && (yield evaluateState(currentState, instance, message))) {
                    result = true;
...
/** @internal */ class InitialiseElements extends Visitor {
    ...
    visitNamedElement(namedElement, deepHistoryAbove) {
        this.behavior(namedElement).leave.push((message, instance) => __awaiter(this, void 0, void 0, function* () { exports.console.log(`${instance} leave ${namedElement.qualifiedName}`); instance.trace(`leave ${namedElement.qualifiedName}`); }));
        this.behavior(namedElement).beginEnter.push((message, instance) => __awaiter(this, void 0, void 0, function* () { exports.console.log(`${instance} enter ${namedElement.qualifiedName}`); instance.trace(`enter ${namedElement.qualifiedName}`); }));
    }
    visitRegion(region, deepHistoryAbove) {
        ...
        if (deepHistoryAbove || !regionInitial || regionInitial.isHistory()) { // NOTE: history needs to be determined at runtime
            this.behavior(region).endEnter.push((message, instance, deepHistory) => __awaiter(this, void 0, void 0, function* () { return yield invoke((this.behavior((deepHistory || regionInitial.isHistory()) ? instance.getLastKnownState(region) || regionInitial : regionInitial)).enter(), message, instance, deepHistory || regionInitial.kind === PseudoStateKind.DeepHistory); }));
        }
        else {
    ...
    visitPseudoState(pseudoState, deepHistoryAbove) {
        ...
        if (pseudoState.isInitial()) {
            ...
            this.behavior(pseudoState).beginEnter.push((message, instance) => __awaiter(this, void 0, void 0, function* () { instance.isTerminated = true; return; }));
        }
    }
...
exports.console = {
    ...
    error(message, ...optionalParams) { throw message; }
};
/**
...
/** @internal */ class Validator extends Visitor {
    ...
    visitPseudoState(pseudoState) {
        ...
        if (pseudoState.kind === PseudoStateKind.Choice || pseudoState.kind === PseudoStateKind.Junction) {
            ...
            if (pseudoState.outgoing.filter((transition) => { return transition.guard === FalseFunc; }).length > 1) {
            ...
            if (pseudoState.outgoing.filter((transition) => { return transition.guard === FalseFunc; }).length !== 0) {
