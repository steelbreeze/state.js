...
var Transition = (function () {
    ...
    /** @internal */ Transition.PseudoStateGuard = function () { return true; };
    /** Guard condition for [[else]] [[Transition]]s. */
    /** @internal */ Transition.ElseGuard = function () { return false; };
    return Transition;
}());
...
var Visitor = (function () {
     ...
     */
    Visitor.prototype.visitNamedElement = function (namedElement, arg1, arg2, arg3) {
    };
    /**
...
/** @internal */ var defaultRandom = function (max) {
 ...
 */
/** @internal */ function invoke(to, message, instance, deepHistory) {
    ...
    InitialiseTransitions.prototype.visitInternalTransition = function (transition, behavior) {
        ...
        if (exports.internalTransitionsTriggerCompletion) {
            transition.onTraverse.push(function (message, instance) {
                var state = transition.source; // the source of an internal transition must be a state
...
/** @internal */ var InitialiseElements = (function (_super) {
    ...
    InitialiseElements.prototype.visitNamedElement = function (namedElement, deepHistoryAbove) {
        if (exports.console !== defaultConsole) {
            this.behavior(namedElement).leave.push(function (message, instance) { return exports.console.log(instance + " leave " + namedElement); });
    ...
    InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        if (deepHistoryAbove || !regionInitial || regionInitial.isHistory()) {
            this.behavior(region).endEnter.push(function (message, instance, deepHistory) { return invoke((_this.behavior((deepHistory || regionInitial.isHistory()) ? instance.getCurrent(region) || regionInitial : regionInitial)).enter(), message, instance, deepHistory || regionInitial.kind === PseudoStateKind.DeepHistory); }); // TODO: can we really assert regionInitial is not null?
        }
        else {
        ...
        if (pseudoState.isInitial()) {
            this.behavior(pseudoState).endEnter.push(function (message, instance, deepHistory) {
                if (instance.getCurrent(pseudoState.parent)) {
                    ...
                    invoke(_this.behavior(instance.getCurrent(pseudoState.parent)).enter(), message, instance, deepHistory || pseudoState.kind === PseudoStateKind.DeepHistory);
                }
                else {
