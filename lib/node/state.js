...
var Transition = (function () {
    function Transition(source, target, kind) {
        ...
        this.guard = source instanceof PseudoState ? function (message, instance) { return true; } : function (message, instance) { return message === _this.source; };
...
var InitialiseStateMachine = (function (_super) {
    ...
    InitialiseStateMachine.prototype.visitElement = function (element, deepHistoryAbove) {
        this.getActions(element).leave.push(function (message, instance, deepHistory) { return exports.logger.log(instance + " leave " + element); });
        this.getActions(element).beginEnter.push(function (message, instance, deepHistory) { return exports.logger.log(instance + " enter " + element); });
    };
    InitialiseStateMachine.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        this.getActions(region).leave.push(function (message, instance, deepHistory) {
    ...
    InitialiseStateMachine.prototype.visitVertex = function (vertex, deepHistoryAbove) {
        ...
        this.getActions(vertex).beginEnter.push(function (message, instance, deepHistory) {
