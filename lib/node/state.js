...
var Vertex = (function (_super) {
     ...
     * @hidden
     */
    Vertex.prototype.invalidate = function () {
        this.parent.invalidate();
    };
    /**
...
var State = (function (_super) {
    ...
    State.prototype.defaultRegion = function () {
        return this.children.filter(function (region) { return region.name === Region.defaultName; })[0];
    };
    /**
...
var InitialiseStateMachine = (function (_super) {
    ...
    InitialiseStateMachine.prototype.visitVertex = function (vertex, deepHistoryAbove) {
        ...
        this.getActions(vertex).beginEnter = delegate_1.delegate(this.getActions(vertex).beginEnter, function (instance, deepHistory) {
            var message = [];
            for (var _i = 2; _i < arguments.length; _i++) {
                message[_i - 2] = arguments[_i];
            }
    ...
    InitialiseStateMachine.prototype.visitStateMachine = function (stateMachine, deepHistoryAbove) {
        ...
        var result = delegate_1.delegate();
        for (var _b = 0, _c = stateMachine.children; _b < _c.length; _b++) {
            var region = _c[_b];
            result = delegate_1.delegate(result, this.getActions(region).beginEnter, this.getActions(region).endEnter);
        }
        return result;
    };
