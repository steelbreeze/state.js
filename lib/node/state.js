...
/** @hidden */
var RuntimeElementActions = (function () {
    function RuntimeElementActions() {
        this.leave = delegate_1.create();
        this.beginEnter = delegate_1.create();
        this.endEnter = delegate_1.create();
    }
    return RuntimeElementActions;
}());
/** @hidden */
var Runtime = (function (_super) {
    ...
    Runtime.prototype.getActions = function (elemenet) {
        return this.elementActions[elemenet.toString()] || (this.elementActions[elemenet.toString()] = new RuntimeElementActions());
    };
