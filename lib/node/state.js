...
function initialise(model, instance, autoInitialiseModel) {
    ...
    if (instance) {
        ...
        exports.console.log("initialise " + instance.name);
...
function evaluate(model, instance, message, autoInitialiseModel) {
    ...
    exports.console.log(instance.name + " evaluate " + message);
...
/** @internal */ var InitialiseElements = (function (_super) {
    ...
    InitialiseElements.prototype.visitNamedElement = function (namedElement, deepHistoryAbove) {
        this.behavior(namedElement).leave.push(function (message, instance) { return exports.console.log(instance.name + " leave " + namedElement.qualifiedName); });
        this.behavior(namedElement).beginEnter.push(function (message, instance) { return exports.console.log(instance.name + " enter " + namedElement.qualifiedName); });
    };
    InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        this.behavior(region).leave.push(function (message, instance) { return invoke(_this.behavior(instance.getCurrent(region)).leave, message, instance); }); // TODO: fix!
        ...
        if (pseudoState.isInitial()) {
            this.behavior(pseudoState).endEnter.push(function (message, instance, deepHistory) {
                if (instance.getCurrent(pseudoState.parent)) {
                    ...
                    invoke(_this.behavior(instance.getCurrent(pseudoState.parent)).enter(), message, instance, deepHistory || pseudoState.kind === PseudoStateKind.DeepHistory); // TODO: fix!
                }
                else {
