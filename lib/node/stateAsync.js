 ...
 */
var NamedElement = /** @class */ (function (_super) {
 ...
 */
var FinalState = /** @class */ (function (_super) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    action = actions_2[_i];
                    return [4 /*yield*/, action(message, instance, deepHistory)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3:
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(autoInitialiseModel && model.clean === false)) return [3 /*break*/, 2];
                    return [4 /*yield*/, initialise(model)];
                case 1:
                    _a.sent();
                    _a.label = 2;
                case 2:
                    ...
                    return [4 /*yield*/, invoke(model.onInitialise, undefined, instance)];
                case 3:
                    // enter the state machine instance for the first time
                    _a.sent();
                    return [3 /*break*/, 5];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, evaluateState(model, instance, message)];
...
/** @internal */ function evaluateState(state, instance, message) {
    return __awaiter(this, void 0, void 0, function () {
        var result, _a, _b, _i, region, currentState, _c, transitions;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    result = false;
                    if (!(message !== state)) return [3 /*break*/, 5];
                    _a = [];
                    for (_b in state.regions)
                        _a.push(_b);
                    _i = 0;
                    _d.label = 1;
                case 1:
                    ...
                    region = _a[_i];
                    currentState = instance.getLastKnownState(state.regions[region]);
                    _c = currentState;
                    if (!_c) return [3 /*break*/, 3];
                    return [4 /*yield*/, evaluateState(currentState, instance, message)];
                case 2:
                    _c = (_d.sent());
                    _d.label = 3;
                case 3:
                ...
                case 5:
                    ...
                    if (!((message !== state) && isComplete(state, instance))) return [3 /*break*/, 7];
                    return [4 /*yield*/, evaluateState(state, instance, state)];
                case 6:
                    _d.sent();
                    _d.label = 7;
                case 7: return [3 /*break*/, 11];
                case 8:
                    transitions = state.outgoing.filter(function (transition) { return transition.guard(message, instance); });
                    if (!(transitions.length === 1)) return [3 /*break*/, 10];
                    return [4 /*yield*/, traverse(transitions[0], instance, message)];
                case 9:
...
/** @internal */ function traverse(transition, instance, message) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    onTraverse = transition.onTraverse.slice(0);
                    ...
                    return [4 /*yield*/, invoke(onTraverse, message, instance)];
                case 1:
                    // execute the transition behavior
                    _a.sent();
                    if (!transition.target) return [3 /*break*/, 5];
                    if (!(transition.target instanceof PseudoState && transition.target.kind === PseudoStateKind.Choice)) return [3 /*break*/, 3];
                    return [4 /*yield*/, traverse(selectTransition(transition.target, instance, message), instance, message)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 5];
                case 3:
                    if (!(transition.target instanceof State && isComplete(transition.target, instance))) return [3 /*break*/, 5];
                    return [4 /*yield*/, evaluateState(transition.target, instance, transition.target)];
                case 4:
                    _a.sent();
                    _a.label = 5;
...
/** @internal */ var Behavior = /** @class */ (function () {
    function Behavior() {
...
/** @internal */ var InitialiseTransitions = /** @class */ (function (_super) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = transition.kind;
                        switch (_a) {
                            case TransitionKind.Internal: return [3 /*break*/, 1];
                            case TransitionKind.Local: return [3 /*break*/, 2];
                            case TransitionKind.External: return [3 /*break*/, 4];
                        }
                        return [3 /*break*/, 5];
                    case 1:
                        this.visitInternalTransition(transition, behavior);
                        return [3 /*break*/, 5];
                    case 2: return [4 /*yield*/, this.visitLocalTransition(transition, behavior)];
                    case 3:
                        _b.sent();
                        return [3 /*break*/, 5];
                    case 4:
    ...
    InitialiseTransitions.prototype.visitInternalTransition = function (transition, behavior) {
        ...
        if (exports.internalTransitionsTriggerCompletion) {
            transition.onTraverse.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(transition.source instanceof State && isComplete(transition.source, instance))) return [3 /*break*/, 2];
                            return [4 /*yield*/, evaluateState(transition.source, instance, transition.source)];
                        case 1:
                            _a.sent();
                            _a.label = 2;
    ...
    InitialiseTransitions.prototype.visitLocalTransition = function (transition, behavior) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                transition.onTraverse.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () {
                    var _this = this;
                    var targetAncestors, i, currentState;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                currentState = instance.getCurrent(targetAncestors[i].parent);
                                if (!currentState) return [3 /*break*/, 2];
                                return [4 /*yield*/, invoke(behavior(currentState).leave, message, instance)];
                            case 1:
                                _a.sent();
                                _a.label = 2;
                            case 2: 
                            // perform the transition action;
                            return [4 /*yield*/, invoke(transition.transitionBehavior, message, instance)];
                            case 3:
                                // perform the transition action;
                                _a.sent();
                                // enter the target ancestry
                                while (i < targetAncestors.length) {
                                    this.cascadeElementEntry(transition, behavior, targetAncestors[i++], targetAncestors[i], function (behavior) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                                        switch (_a.label) {
                                            case 0: return [4 /*yield*/, invoke(behavior, message, instance)];
                                            case 1: return [2 /*return*/, _a.sent()];
                                        }
                                    }); }); });
                                }
                                // trigger cascade
                                return [4 /*yield*/, invoke(behavior(transition.target).endEnter, message, instance)];
                            case 4:
                                // trigger cascade
                                _a.sent();
                                return [2 /*return*/];
...
/** @internal */ var InitialiseElements = /** @class */ (function (_super) {
    ...
    InitialiseElements.prototype.visitNamedElement = function (namedElement, deepHistoryAbove) {
        var _this = this;
        this.behavior(namedElement).leave.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, exports.console.log(instance + " leave " + namedElement.qualifiedName)];
        }); }); });
        this.behavior(namedElement).beginEnter.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, exports.console.log(instance + " enter " + namedElement.qualifiedName)];
        }); }); });
    };
    InitialiseElements.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        this.behavior(region).leave.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () {
            var currentState;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        currentState = instance.getCurrent(region);
                        if (!currentState) return [3 /*break*/, 2];
                        return [4 /*yield*/, invoke(this.behavior(currentState).leave, message, instance)];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2 /*return*/];
        ...
        if (deepHistoryAbove || !regionInitial || regionInitial.isHistory()) { // NOTE: history needs to be determined at runtime
            this.behavior(region).endEnter.push(function (message, instance, deepHistory) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, invoke((this.behavior((deepHistory || regionInitial.isHistory()) ? instance.getLastKnownState(region) || regionInitial : regionInitial)).enter(), message, instance, deepHistory || regionInitial.kind === PseudoStateKind.DeepHistory)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            }); }); });
        }
    ...
    InitialiseElements.prototype.visitVertex = function (vertex, deepHistoryAbove) {
        ...
        this.behavior(vertex).beginEnter.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (vertex.parent) {
    ...
    InitialiseElements.prototype.visitPseudoState = function (pseudoState, deepHistoryAbove) {
        ...
        if (pseudoState.isInitial()) {
            this.behavior(pseudoState).endEnter.push(function (message, instance, deepHistory) { return __awaiter(_this, void 0, void 0, function () {
                var currentState;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!((deepHistory || pseudoState.isHistory()) && (currentState = instance.getLastKnownState(pseudoState.parent)))) return [3 /*break*/, 3];
                            return [4 /*yield*/, invoke(this.behavior(pseudoState).leave, message, instance)];
                        case 1:
                            _a.sent();
                            return [4 /*yield*/, invoke(this.behavior(currentState).enter(), message, instance, deepHistory || pseudoState.kind === PseudoStateKind.DeepHistory)];
                        case 2:
                            _a.sent();
                            return [3 /*break*/, 5];
                        case 3: return [4 /*yield*/, traverse(pseudoState.outgoing[0], instance)];
                        case 4:
                            _a.sent();
                            _a.label = 5;
                        case 5: return [2 /*return*/];
            ...
            this.behavior(pseudoState).beginEnter.push(function (message, instance) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
...
/** @internal */ var Validator = /** @class */ (function (_super) {
