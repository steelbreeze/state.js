...
/** @internal */ class InitialiseElements extends Visitor {
    ...
    visitNamedElement(namedElement, deepHistoryAbove) {
        this.behavior(namedElement).leave.push((message, instance) => __awaiter(this, void 0, void 0, function* () { return exports.console.log(`${instance} leave ${namedElement.qualifiedName}`); }));
        this.behavior(namedElement).beginEnter.push((message, instance) => __awaiter(this, void 0, void 0, function* () { return exports.console.log(`${instance} enter ${namedElement.qualifiedName}`); }));
    }
