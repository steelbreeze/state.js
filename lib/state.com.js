...
(function (StateJS) {
    ...
    var InitialiseElements = (function (_super) {
        ...
        function InitialiseElements() {
            _super.apply(this, arguments);
            this.behaviours = []; // TODO: type well, but without introducing an interface
        }
        InitialiseElements.prototype.behaviour = function (element) {
            return this.behaviours[element.qualifiedName] || (this.behaviours[element.qualifiedName] = [new StateJS.Behavior(), new StateJS.Behavior(), new StateJS.Behavior()]);
        };
        InitialiseElements.prototype.visitElement = function (element, deepHistoryAbove) {
            if (StateJS.console !== defaultConsole) {
                this.behaviour(element)[leave].push(function (message, instance) { return StateJS.console.log(instance + " leave " + element); });
                this.behaviour(element)[beginEnter].push(function (message, instance) { return StateJS.console.log(instance + " enter " + element); });
            }
        };
