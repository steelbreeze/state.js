...
(function (StateJS) {
    ...
    var Evaluator = (function (_super) {
        ...
        Evaluator.prototype.invokeTransition = function (transition, instance, message) {
        ...
        Evaluator.prototype.selectJunctionTransition = function (vertex, stateMachineInstance, message) {
        ...
        Evaluator.prototype.selectChoiceTransition = function (vertex, stateMachineInstance, message) {
            var _this = this;
            var results = [];
            var elseResult;
            vertex.transitions.forEach(function (t) {
