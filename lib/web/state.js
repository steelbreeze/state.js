...
var InitialiseStateMachine = (function (_super) {
    ...
    InitialiseStateMachine.prototype.visitElement = function (element, deepHistoryAbove) {
        this.getActions(element).leave = delegate_1.delegate(this.getActions(element).leave, function (instance, deepHistory) { return logger.log(instance + " leave " + element); });
        this.getActions(element).beginEnter = delegate_1.delegate(this.getActions(element).beginEnter, function (instance, deepHistory) { return logger.log(instance + " enter " + element); });
    };
    InitialiseStateMachine.prototype.visitRegion = function (region, deepHistoryAbove) {
        ...
        this.getActions(region).leave = delegate_1.delegate(this.getActions(region).leave, function (instance, deepHistory) {
            ...
            (_a = _this.getActions(instance.getCurrent(region))).leave.apply(_a, [instance, false].concat(message));
            var _a;
        });
