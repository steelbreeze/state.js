...
var PseudoState = (function (_super) {
    ...
    /*internal*/ PseudoState.prototype.selectTransition = function (instance, message) {
    ...
    /*internal*/ PseudoState.prototype.findElse = function () {
...
var State = (function (_super) {
    ...
    /*internal*/ State.prototype.evaluateState = function (instance, message) {
        var _this = this;
        var result = false;
...
var StateMachine = (function () {
    ...
    /*internal*/ StateMachine.prototype.evaluateState = function (instance, message) {
        var _this = this;
        var result = false;
        // delegate to child regions first if a non-continuation
        this.regions.every(function (region) {
...
var Transition = (function () {
    ...
    /*internal*/ Transition.prototype.traverse = function (instance, message) {
        var onTraverse = new Actions(this.onTraverse);
        var transition = this;
