...
/** @internal */ var InitialiseElements = (function (_super) {
    ...
    InitialiseElements.prototype.visitNamedElement = function (namedElement, deepHistoryAbove) {
        if (console !== defaultConsole) {
            this.behavior(namedElement).leave.push(function (message, instance) { return console.log(instance + " leave " + namedElement); });
            this.behavior(namedElement).beginEnter.push(function (message, instance) { return console.log(instance + " enter " + namedElement); });
        }
    };
