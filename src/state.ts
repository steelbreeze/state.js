...
module fsm {
    ...
    export class Element {
         ...
         */
         toString(): string {
            return this.ancestors().map<string>((e)=> { return e.name; }).join(Element.namespaceSeparator); // NOTE: while this may look costly, only used at runtime rarely if ever
        }
    }
    ...
    export class Vertex extends Element {
        ...
        protected transitions: Array<Transition> = [];
