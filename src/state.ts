...
module fsm {
    ...
    export class Region extends Element {
         ...
         */
        constructor(name: string, private parent: State) {
            super(name);
    ...
    export class Vertex extends Element {
        ...
        private selector: Selector; // TODO: turn this into a virtual method?

        constructor(name: string, parent: Region, selector: Selector);
        constructor(name: string, parent: State, selector: Selector);
        constructor(name: string, parent: any, selector: Selector) {
            super(name);
    ...
    function pseudoState(kind: PseudoStateKind): (transitions: Array<Transition>, message: any, instance: IActiveStateConfiguration) => Transition {
        switch(kind) {
    ...
    function initial(transitions: Array<Transition>, message: any, instance: IActiveStateConfiguration): Transition {
    ...
    function terminate(transitions: Array<Transition>, message: any, instance: IActiveStateConfiguration): Transition {        
        return;
    }
