...
throw"Initial transition must have a single outbound transition"}function n(t,e,i){for(var n,r=0,o=t.length;o>r;r++)if(t[r].guard(e,i)){if(n)throw"Multiple outbound transitions evaluated true"
n=t[r]}if(!n)for(r=0;o>r;r++)if(t[r].guard===g.isElse){if(n)throw"Multiple outbound transitions evaluated true"
n=t[r]}return n}function r(t,e,i){for(var n,r=[],o=0,s=t.length;s>o;o++)t[o].guard(e,i)&&r.push(t[o])
if(0!==r.length&&(n=r[Math.round((r.length-1)*Math.random())]),!n)for(o=0;s>o;o++)if(t[o].guard===g.isElse){if(n)throw"Multiple outbound transitions evaluated true"
n=t[o]}return n}function o(){}function s(t,e,i,n){for(var r=0,o=t.length;o>r;r++)t[r](e,i,n)}function a(t,e){if(!t)throw e}var h=function(){function t(t){this.name=t,this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[]}return t.prototype.getParent=function(){},t.prototype.root=function(){return this.getParent().root()},t.prototype.ancestors=function(){return(this.getParent()?this.getParent().ancestors():[]).concat(this)},t.prototype.isActive=function(t){return this.getParent().isActive(t)},t.prototype.reset=function(){this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[]},t.prototype.bootstrap=function(){this.qualifiedName=this.ancestors().map(function(t){return t.name}).join(t.namespaceSeparator),this.enter=this.beginEnter.concat(this.endEnter)},t.prototype.toString=function(){return this.qualifiedName},t.namespaceSeparator=".",t}()
t.Element=h
...
return t||(t=new u(u.defaultName,this)),t},e.prototype.isActive=function(e){return t.prototype.isActive.call(this,e)&&e.getCurrent(this.region)===this},e.prototype.isFinal=function(){return 0===this.transitions.length},e.prototype.isSimple=function(){return 0===this.regions.length},e.prototype.isComposite=function(){return this.regions.length>0},e.prototype.isOrthogonal=function(){return this.regions.length>1},e.prototype.isComplete=function(t){for(var e=0,i=this.regions.length;i>e;e++)if(this.regions[e].isComplete(t)===!1)return!1
return!0},e.prototype.exit=function(t){return this.exitBehavior.push(t),this.root().clean=!1,this},e.prototype.entry=function(t){return this.entryBehavior.push(t),this.root().clean=!1,this},e.prototype.bootstrap=function(e){for(var i=this,n=0,r=this.regions.length;r>n;n++){var o=this.regions[n]
...
t.prototype.bootstrapTransitions.call(this)},e.prototype.evaluate=function(e,i){for(var n=!1,r=0,o=this.regions.length;o>r;r++)this.isActive(i)===!0&&this.regions[r].evaluate(e,i)&&(n=!0)
...
else{for(var t=this.source.ancestors(),e=this.target.ancestors(),i=t.length,n=e.length,r=0,o=Math.min(i,n);o>r&&t[r]===e[r];)r++
for(a(!(t[r]instanceof u),"Transitions may not cross sibling orthogonal region boundaries"),this.traverse=(i>r?t[r]:this.source).leave.slice(0),this.traverse=this.traverse.concat(this.transitionBehavior),r>=n&&(this.traverse=this.traverse.concat(this.target.beginEnter));n>r;){var s=e[r++],h=n>r?e[r]:void 0
if(this.traverse=this.traverse.concat(s.beginEnter),s instanceof l){var c=s
if(c.isOrthogonal())for(var p=0,f=c.regions.length;f>p;p++){var v=c.regions[p]
v!==h&&(this.traverse=this.traverse.concat(v.enter))}}}this.traverse=this.traverse.concat(this.target.endEnter)}},t.isElse=function(){return!1},t}()
t.Transition=g
var y=function(){function t(t){void 0===t&&(t="unnamed"),this.name=t,this.isTerminated=!1,this.last={}}return t.prototype.setCurrent=function(t,e){this.last[t.qualifiedName]=e},t.prototype.getCurrent=function(t){return this.last[t.qualifiedName]},t.prototype.toString=function(){return this.name},t}()
