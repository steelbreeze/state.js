...
for(r=0;o>r;r++)if(t[r].guard(e,i)){if(n)throw"Multiple outbound transitions evaluated true"
...
for(r=0;s>r;r++)t[r].guard(e,i)&&o.push(t[r])
...
for(var n=0,r=this.regions.length;r>n;n++)this.regions[n]!==i&&e(this.regions[n].enter)},e.prototype.evaluate=function(e,i){for(var n=!1,r=0,o=this.regions.length;o>r;r++)this.isActive(i)===!0&&this.regions[r].evaluate(e,i)&&(n=!0)
