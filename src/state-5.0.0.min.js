...
!function(t){function e(t){switch(t){case 1:case 4:case 3:return i
case 2:return n
case 0:return r
...
t.Vertex=c,function(t){t[t.Choice=0]="Choice",t[t.Initial=1]="Initial",t[t.Junction=2]="Junction",t[t.ShallowHistory=3]="ShallowHistory",t[t.DeepHistory=4]="DeepHistory",t[t.Terminate=5]="Terminate"}(t.PseudoStateKind||(t.PseudoStateKind={}))
var p=(t.PseudoStateKind,function(t){function i(i,n,r){t.call(this,i,n,e(r)),this.kind=r,this.isInitial()&&(this.region.initial=this)}return __extends(i,t),i.prototype.isHistory=function(){return 4===this.kind||3===this.kind},i.prototype.isInitial=function(){return 1===this.kind||this.isHistory()},i.prototype.bootstrap=function(e){t.prototype.bootstrap.call(this,e),5===this.kind&&this.enter.push(function(t,e){e.isTerminated=!0})},i}(c))
t.PseudoState=p
