...
i.prototype=e.prototype,t.prototype=new i},state
!function(t){function e(t){switch(t){case 2:case 1:case 4:return i
case 3:return n
case 0:return r
...
n=t[r]}if(!n)for(r=0;o>r;r++)if(t[r].guard===g.isElse){if(n)throw"Multiple outbound transitions evaluated true"
n=t[r]}return n}function r(t,e,i){var n,r,o=[],s=t.length
for(r=0;s>r;r++)t[r].guard(e,i)===!0&&o.push(t[r])
if(0!==o.length&&(n=o[Math.round((o.length-1)*Math.random())]),!n)for(r=0;s>r;r++)if(t[r].guard===g.isElse){if(n)throw"Multiple outbound transitions evaluated true"
n=t[r]}return n}function o(){}function s(t,e,i,n){for(var r=0,o=t.length;o>r;r++)t[r](e,i,n)}function a(t,e){if(!t)throw e}!function(t){t[t.Choice=0]="Choice",t[t.DeepHistory=1]="DeepHistory",t[t.Initial=2]="Initial",t[t.Junction=3]="Junction",t[t.ShallowHistory=4]="ShallowHistory",t[t.Terminate=5]="Terminate"}(t.PseudoStateKind||(t.PseudoStateKind={}))
var h=(t.PseudoStateKind,function(){function t(t,e){this.name=t,this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[],e&&(this.root=e.root,this.root.clean=!1)}return t.prototype.ancestors=function(){return(this.parent()?this.parent().ancestors():[]).concat(this)},t.prototype.reset=function(){this.leave=[],this.beginEnter=[],this.endEnter=[],this.enter=[]},t.prototype.bootstrap=function(){this.enter=this.beginEnter.concat(this.endEnter)},t.prototype.bootstrapEnter=function(t){t(this.beginEnter)},t.prototype.toString=function(){return this.ancestors().map(function(t){return t.name}).join(t.namespaceSeperator)},t.namespaceSeperator=".",t}())
t.Element=h
var u=function(t){function e(e,i){var n=this
t.call(this,e,i),this.state=i,this.vertices=[],i.regions.push(this),this.parent=function(){return n.state}}return __extends(e,t),e.prototype.isComplete=function(t){return t.getCurrent(this).isFinal()},e.prototype.bootstrap=function(e){for(var i=this,n=0,r=this.vertices.length;r>n;n++)this.vertices[n].reset(),this.vertices[n].bootstrap(e||this.initial&&1===this.initial.kind)
this.leave.push(function(t,e,n){var r=e.getCurrent(i)
r.leave&&s(r.leave,t,e,n)}),e||!this.initial||this.initial.isHistory()?this.endEnter.push(function(t,e,n){var r=i.initial;(n||i.initial.isHistory())&&(r=e.getCurrent(i)||i.initial),s(r.enter,t,e,n||1===i.initial.kind)}):this.endEnter=this.endEnter.concat(this.initial.enter),t.prototype.bootstrap.call(this,e)},e.prototype.bootstrapTransitions=function(){for(var t=0,e=this.vertices.length;e>t;t++)this.vertices[t].bootstrapTransitions()},e.prototype.evaluate=function(t,e){return e.getCurrent(this).evaluate(t,e)},e.defaultName="default",e}(h)
t.Region=u
var c=function(t){function e(e,i,n){var r=this
t.call(this,e,i),this.transitions=[],this.selector=n,i instanceof u?this.region=i:i instanceof l&&(this.region=i.defaultRegion()),this.region&&this.region.vertices.push(this),this.parent=function(){return r.region}}return __extends(e,t),e.prototype.to=function(t){var e=new g(this,t)
return this.transitions.push(e),this.root.clean=!1,e},e.prototype.bootstrap=function(e){var i=this
t.prototype.bootstrap.call(this,e),this.endEnter.push(function(t,e,n){i.evaluateCompletions(t,e,n)}),this.enter=this.beginEnter.concat(this.endEnter)},e.prototype.bootstrapTransitions=function(){for(var t=0,e=this.transitions.length;e>t;t++)this.transitions[t].bootstrap()},e.prototype.evaluateCompletions=function(t,e){this.isComplete(e)&&this.evaluate(this,e)},e.prototype.isFinal=function(){return 0===this.transitions.length},e.prototype.isComplete=function(){return!0},e.prototype.evaluate=function(t,e){var i=this.selector(this.transitions,t,e)
return i?(s(i.traverse,t,e,!1),!0):!1},e}(h)
t.Vertex=c
var p=function(t){function i(i,n,r){t.call(this,i,n,e(r)),this.kind=r,this.isInitial()&&(this.region.initial=this)}return __extends(i,t),i.prototype.isHistory=function(){return 1===this.kind||4===this.kind},i.prototype.isInitial=function(){return 2===this.kind||this.isHistory()},i.prototype.bootstrap=function(e){t.prototype.bootstrap.call(this,e),5===this.kind&&this.enter.push(function(t,e){e.isTerminated=!0})},i}(c)
t.PseudoState=p
var l=function(t){function e(i,n){t.call(this,i,n,e.selector),this.regions=[],this.exitBehavior=[],this.entryBehavior=[]}return __extends(e,t),e.selector=function(t,e,i){for(var n,r=0,o=t.length;o>r;r++)if(t[r].guard(e,i)){if(n)throw"Multiple outbound transitions evaluated true"
...
return t||(t=new u(u.defaultName,this)),t},e.prototype.exit=function(t){return this.exitBehavior.push(t),this.root.clean=!1,this},e.prototype.entry=function(t){return this.entryBehavior.push(t),this.root.clean=!1,this},e.prototype.isSimple=function(){return 0===this.regions.length},e.prototype.isComposite=function(){return this.regions.length>0},e.prototype.isOrthogonal=function(){return this.regions.length>1},e.prototype.bootstrap=function(e){for(var i=this,n=0,r=this.regions.length;r>n;n++){var o=this.regions[n]
...
t.FinalState=f
var v=function(t){function e(e){t.call(this,e,void 0),this.clean=!0,this.root=this}return __extends(e,t),e.prototype.bootstrap=function(e){t.prototype.bootstrap.call(this,e),t.prototype.bootstrapTransitions.call(this),this.clean=!0},e.prototype.initialise=function(t,e){void 0===e&&(e=!0),e&&this.clean===!1&&this.bootstrap(!1),s(this.enter,void 0,t,!1)},e.prototype.evaluate=function(e,i){return i.isTerminated?!1:t.prototype.evaluate.call(this,e,i)},e}(l)
t.StateMachine=v
var g=function(){function t(t,e){this.source=t,this.target=e,this.transitionBehavior=[],this.traverse=[],this.completion()}return t.prototype.completion=function(){var t=this
return this.guard=function(e){return e===t.source},this},t.prototype["else"]=function(){return this.guard=t.isElse,this},t.prototype.when=function(t){return this.guard=t,this},t.prototype.effect=function(t){return this.transitionBehavior.push(t),this.source.root.clean=!1,this},t.prototype.bootstrap=function(){var t=this
if(null===this.target)this.traverse=this.transitionBehavior
else if(this.target.parent()===this.source.parent())this.traverse=this.source.leave.concat(this.transitionBehavior).concat(this.target.enter)
