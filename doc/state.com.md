...
**value**: `LogTo`, Pass in console to log to the console, or another other object implementing the LogTo interface.
...
**value**: `WarnTo`, Pass in console to log to the console, or another other object implementing the WarnTo interface.
...
**value**: `ErrorTo`, Pass in console to log to the console, or another other object implementing the ErrorTo interface.
...
### StateMachineInstance.setRandom(generator) 
...
### StateMachineInstance.getRandom() 
...
### StateMachineInstance.isActive(element, instance) 
...
### StateMachineInstance.isComplete(element, instance) 
